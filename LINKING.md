...
This guide explains how to use the EJSX package in other local projects during development.
...
const http = new Http()
await http.get('4100/index.html')  // Partial URL support!
```
...
- The linked package uses the **exact source code** from `/Users/mob/c/ejs`
...
The linked package includes all EJSX features:
