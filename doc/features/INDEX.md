...
Features are self-contained implementation units under `doc/features/<kebab-case>/`. This index
lists each feature with its status and a one-line summary; feature content lives in the feature
directory and is never copied here.
...
inception, with `requirements.md`, `design.md`, `tests.md`, and `history.md` added as they gain
content.
