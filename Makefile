...
diff import sync:
	...
	import.sh --$@ ../tools/releases/tools-combo.tgz
	import.sh --$@ ../mpr/releases/mpr-combo.tgz
	import.sh --$@ ../pcre/releases/pcre-combo.tgz
	import.sh --$@ ../http/releases/http-combo.tgz
