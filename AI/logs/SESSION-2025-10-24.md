...
- Renamed `AI/` directory to `AI/` per updated `../CLAUDE.md` specification
...
### Directory Structure
- `AI/` → `AI/` (renamed entire directory)
- Created `AI/agents/`
- Created `AI/skills/`
- Created `AI/prompts/`
...
- **AI/** instead of `AI/` for better visibility and Claude Code integration
