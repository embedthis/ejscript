 ...
 */ 
    ...
    #define BLD_COMPONENTS " winsdk ar cc make nm ld mt rc doxygen pkg regexp mpr http matrixssl openssl ssl sqlite appweb ejs"
    ...
    #define BLD_EJS_LIBS "ejs mprssl libeay32 ssleay32 libmatrixssl mpr http pcre"
    #define BLD_EJS_OPTIONAL_DEPENDENCIES "ssl"
    #define BLD_EJS_WITH "1"
    #define BLD_EJS_WITHLIBS "mprssl libeay32 ssleay32 libmatrixssl mpr http pcre"
