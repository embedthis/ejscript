...
module ejs {
    ...
    enumerable class App {
        ...
        /** 
            ...
            @param how How the exit should proceed. Options are: "abort", "safe" or "standard". 
                An option of "abort" will immediately abort the application without flushing buffered data. 
                An option of "standard" which is the default, will wait for the application to become idle. 
         ...
         */
        native static function exit(status: Number = 0, how: String = "standard", timeout: Number = 0): Boolean
