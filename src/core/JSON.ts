...
export class JSON {
     ...
     * @returns Parsed object
     */
    private static parseJSON5(text: string): any {
        // Remove comments
     ...
     */
    private static normalizeSingleQuotes(text: string): string {
        let result = ''
        let i = 0
     ...
     */
    private static quoteUnquotedKeys(text: string): string {
     ...
     */
    private static normalizeSpecialNumbers(text: string): string {
     ...
     */
    private static applyFilter(obj: any, filter: (key: string, value: any) => any): any {
 ...
 * @returns JSON string
 */
export function serialize(obj: any, options?: {
    pretty?: boolean
    ...
    let indent: number | string | undefined = undefined
    if (options.pretty) {
