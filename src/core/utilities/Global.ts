 ...
 */
export function blend(dest: any, src: any, options?: { overwrite?: boolean; functions?: boolean }): any {
 ...
 * @param args Objects to dump
 */
export function dumpAll(...args: any[]): void {
    for (const obj of args) {
        print(serialize(obj, { pretty: true }))
    }
}
 ...
 * @param args Objects to dump
 */
export function dumpDef(...args: any[]): void {
    for (const obj of args) {
 ...
 * @param args Values to print
 */
export function prints(...args: any[]): void {
    const output = args.map(arg => String(arg)).join(' ')
    App.outputStream.write(output)
}
...
export function printf(fmt: string, ...args: any[]): void {
    ...
    const formatted = (fmt as any).format(args)
 ...
 */
export function printHash(name: string, obj: any): void {
 ...
 */
export function parse(str: string, preferredType?: any): any {
 ...
 */
export function instanceOf(obj: any, target: any): boolean {
 ...
 */
export function setIntervalTimer(callback: Function, delay: number, ...args: any[]): Timer {
 ...
 */
export function clearIntervalTimer(timer: Timer): void {
    timer.stop()
}
 ...
 * @returns Timer instance
 */
export function setTimeoutTimer(callback: Function, delay: number, ...args: any[]): Timer {
    const timer = new Timer(delay, callback, ...args)
    timer.start()
    return timer
}
 ...
 */
export function clearTimeoutTimer(timer: Timer): void {
    timer.stop()
}
