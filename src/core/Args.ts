...
export interface ArgsTemplate {
    ...
    options: { [key: string]: ArgsOptionSpec }
...
export class Args {
     ...
     */
    constructor(template: ArgsTemplate, argv: string[] = App.args) {
     ...
     */
    private cloneTemplate(template: ArgsTemplate): ArgsTemplate {
        const cloned: ArgsTemplate = {
            options: {},
     ...
     */
    private validateItem(key: string, item: ArgsOptionSpec, value: any): any {
