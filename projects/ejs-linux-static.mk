#
#   ejs-linux-static.mk -- Makefile to build Embedthis Ejscript Javascript Language for linux
#
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/ejs-linux-static-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/ejs-linux-static-bit.h >/dev/null ; then\
		cp projects/ejs-linux-static-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
