...
#   libhttp
#
DEPS_125 += $(BUILD)/bin/libmpr.a
ifeq ($(ME_COM_PCRE),1)
    DEPS_125 += $(BUILD)/bin/libpcre.a
endif
DEPS_125 += $(BUILD)/inc/http.h
DEPS_125 += $(BUILD)/obj/httpLib.o

$(BUILD)/bin/libhttp.a: $(DEPS_125)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_140 += $(BUILD)/bin/libzlib.a
endif
DEPS_140 += $(BUILD)/obj/ejsZlib.o

$(BUILD)/bin/libejs.zlib.a: $(DEPS_140)
...
DEPS_142 += $(BUILD)/bin/libejs.zlib.a
...
ifeq ($(ME_COM_SQLITE),1)
    DEPS_147 += $(BUILD)/bin/libsql.a
endif
DEPS_147 += $(BUILD)/obj/ejsSqlite.o

$(BUILD)/bin/libejs.db.sqlite.a: $(DEPS_147)
...
$(BUILD)/bin/libejs.web.a: $(DEPS_148)
