#
#   build.mk -- Build It Makefile to build Embedthis Ejscript for linux on i686
#
...
linux-i686-debug/lib/ejs.db.mod:  \
        $(PLATFORM)/bin/ejsc \
        $(PLATFORM)/bin/ejsmod \
        $(PLATFORM)/lib/ejs.mod
	ejsc --out $(PLATFORM)/lib/ejs.db.mod --debug --optimize 9 src/jems/ejs.db/*.es

linux-i686-debug/lib/ejs.db.mapper.mod:  \
        $(PLATFORM)/bin/ejsc \
        $(PLATFORM)/bin/ejsmod \
        $(PLATFORM)/lib/ejs.mod \
        $(PLATFORM)/lib/ejs.db.mod
...
linux-i686-debug/lib/ejs.db.sqlite.mod:  \
        $(PLATFORM)/bin/ejsc \
        $(PLATFORM)/bin/ejsmod \
        $(PLATFORM)/lib/ejs.mod
...
linux-i686-debug/lib/ejs.mvc.mod:  \
        $(PLATFORM)/bin/ejsc \
        $(PLATFORM)/bin/ejsmod \
        $(PLATFORM)/lib/ejs.mod \
        $(PLATFORM)/lib/ejs.web.mod \
...
linux-i686-debug/bin/utest.worker: 
