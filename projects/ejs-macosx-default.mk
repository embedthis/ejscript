...
ifeq ($(BIT_PACK_MATRIXSSL),1)
    LIBS_13 += -lmatrixssl
    LIBPATHS_13 += -L$(BIT_PACK_MATRIXSSL_PATH)
endif
ifeq ($(BIT_PACK_NANOSSL),1)
    LIBS_13 += -lssls
    LIBPATHS_13 += -L$(BIT_PACK_NANOSSL_PATH)/bin
endif
ifeq ($(BIT_PACK_OPENSSL),1)
    LIBS_13 += -lssl
    LIBPATHS_13 += -L$(BIT_PACK_OPENSSL_PATH)
endif
ifeq ($(BIT_PACK_OPENSSL),1)
    LIBS_13 += -lcrypto
    LIBPATHS_13 += -L$(BIT_PACK_OPENSSL_PATH)
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_13)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 2.3.1 -current_version 2.3.1 $(CONFIG)/obj/mprSsl.o $(LIBPATHS_13) $(LIBS_13) $(LIBS_13) $(LIBS) 
...
$(CONFIG)/bin/ejsman: $(DEPS_15)
	...
	$(CC) -o $(CONFIG)/bin/ejsman -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBPATHS_15) $(LIBS_15) $(LIBS_15) $(LIBS) 
...
#   makerom
#
DEPS_17 += $(CONFIG)/bin/libmpr.dylib
...
$(CONFIG)/bin/libpcre.dylib: $(DEPS_21)
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_24)
	@echo '      [Link] $(CONFIG)/bin/libhttp.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 2.3.1 -current_version 2.3.1 $(CONFIG)/obj/httpLib.o $(LIBPATHS_24) $(LIBS_24) $(LIBS_24) $(LIBS) -lpam 
...
$(CONFIG)/bin/http: $(DEPS_26)
	...
	$(CC) -o $(CONFIG)/bin/http -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/http.o -lpam $(LIBPATHS_26) $(LIBS_26) $(LIBS_26) $(LIBS) 
...
$(CONFIG)/bin/libsqlite3.dylib: $(DEPS_29)
...
#   sqliteshell
#
DEPS_31 += $(CONFIG)/bin/libsqlite3.dylib
DEPS_31 += $(CONFIG)/obj/sqlite.o

LIBS_31 += -lsqlite3

$(CONFIG)/bin/sqliteshell: $(DEPS_31)
	@echo '      [Link] $(CONFIG)/bin/sqliteshell'
	$(CC) -o $(CONFIG)/bin/sqliteshell -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/sqlite.o $(LIBPATHS_31) $(LIBS_31) $(LIBS_31) $(LIBS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_106)
	...
	$(CC) -o $(CONFIG)/bin/ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o -lpam $(LIBPATHS_106) $(LIBS_106) $(LIBS_106) $(LIBS) -ledit 
...
#   ejsc
#
DEPS_108 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/bin/ejsc: $(DEPS_108)
	...
	$(CC) -o $(CONFIG)/bin/ejsc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o -lpam $(LIBPATHS_108) $(LIBS_108) $(LIBS_108) $(LIBS) 
...
$(CONFIG)/bin/ejsmod: $(DEPS_115)
	...
	$(CC) -o $(CONFIG)/bin/ejsmod -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsmod.o $(CONFIG)/obj/doc.o $(CONFIG)/obj/docFiles.o $(CONFIG)/obj/listing.o $(CONFIG)/obj/slotGen.o -lpam $(LIBPATHS_115) $(LIBS_115) $(LIBS_115) $(LIBS) 
...
$(CONFIG)/bin/ejsrun: $(DEPS_117)
	...
	$(CC) -o $(CONFIG)/bin/ejsrun -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o -lpam $(LIBPATHS_117) $(LIBS_117) $(LIBS_117) $(LIBS) 
...
$(CONFIG)/bin/jem: $(DEPS_121)
	...
	$(CC) -o $(CONFIG)/bin/jem -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o -lpam $(LIBPATHS_121) $(LIBS_121) $(LIBS_121) $(LIBS) 
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_126 += $(CONFIG)/bin/libsqlite3.dylib
endif
...
$(CONFIG)/bin/libejs.db.sqlite.dylib: $(DEPS_126)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.db.sqlite.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.db.sqlite.dylib -compatibility_version 2.3.1 -current_version 2.3.1 $(CONFIG)/obj/ejsSqlite.o -lpam $(LIBPATHS_126) $(LIBS_126) $(LIBS_126) $(LIBS) 
...
$(CONFIG)/bin/libejs.web.dylib: $(DEPS_134)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.web.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.web.dylib -compatibility_version 2.3.1 -current_version 2.3.1 $(CONFIG)/obj/ejsHttpServer.o $(CONFIG)/obj/ejsRequest.o $(CONFIG)/obj/ejsSession.o $(CONFIG)/obj/ejsWeb.o -lpam $(LIBPATHS_134) $(LIBS_134) $(LIBS_134) $(LIBS) 
...
ifeq ($(BIT_PACK_ZLIB),1)
    DEPS_139 += $(CONFIG)/bin/libzlib.dylib
endif
...
$(CONFIG)/bin/libejs.zlib.dylib: $(DEPS_139)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.zlib.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.3.1 -current_version 2.3.1 $(CONFIG)/obj/ejsZlib.o -lpam $(LIBPATHS_139) $(LIBS_139) $(LIBS_139) $(LIBS) 
...
$(CONFIG)/bin/mvc: $(DEPS_142)
	...
	$(CC) -o $(CONFIG)/bin/mvc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o -lpam $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) 
...
#   utest
#
DEPS_146 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/bin/utest: $(DEPS_146)
	...
	$(CC) -o $(CONFIG)/bin/utest -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o -lpam $(LIBPATHS_146) $(LIBS_146) $(LIBS_146) $(LIBS) 
