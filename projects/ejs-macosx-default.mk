...
$(CONFIG)/bin/libejs.web.dylib: $(DEPS_126)
	@echo '      [Link] libejs.web'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.web.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libejs.web.dylib $(CONFIG)/obj/ejsHttpServer.o $(CONFIG)/obj/ejsRequest.o $(CONFIG)/obj/ejsSession.o $(CONFIG)/obj/ejsWeb.o $(LIBS_126) $(LIBS_126) $(LIBS) -lpam
...
DEPS_131 += $(CONFIG)/bin/libzlib.dylib
...
$(CONFIG)/bin/libejs.zlib.dylib: $(DEPS_131)
	@echo '      [Link] libejs.zlib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.zlib.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib $(CONFIG)/obj/ejsZlib.o $(LIBS_131) $(LIBS_131) $(LIBS) -lpam
...
$(CONFIG)/bin/mvc: $(DEPS_134)
	@echo '      [Link] mvc'
	$(CC) -o $(CONFIG)/bin/mvc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_134) $(LIBS_134) $(LIBS) -lpam
...
$(CONFIG)/bin/utest: $(DEPS_138)
	@echo '      [Link] utest'
	$(CC) -o $(CONFIG)/bin/utest -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_138) $(LIBS_138) $(LIBS) -lpam
