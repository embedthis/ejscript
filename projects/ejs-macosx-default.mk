...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_8)
	@echo '      [Link] libmprssl'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libmprssl.dylib $(CONFIG)/obj/mprSsl.o $(LIBS_8) $(LIBS_8) $(LIBS)
...
$(CONFIG)/bin/ejsman: $(DEPS_10)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/ejsman -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_10) $(LIBS_10) $(LIBS)
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_19)
	@echo '      [Link] libhttp'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libhttp.dylib $(CONFIG)/obj/httpLib.o $(LIBS_19) $(LIBS_19) $(LIBS) -lpam
...
$(CONFIG)/bin/libzlib.dylib: $(DEPS_29)
	@echo '      [Link] libzlib'
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_99)
	@echo '      [Link] libejs'
...
$(CONFIG)/bin/ejs: $(DEPS_101)
	@echo '      [Link] ejs'
	$(CC) -o $(CONFIG)/bin/ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS_101) $(LIBS_101) $(LIBS) -ledit
...
$(CONFIG)/bin/ejsc: $(DEPS_103)
	@echo '      [Link] ejsc'
	$(CC) -o $(CONFIG)/bin/ejsc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBS_103) $(LIBS_103) $(LIBS) -lpam
...
#   ejsmod
#
DEPS_110 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/bin/ejsmod: $(DEPS_110)
	@echo '      [Link] ejsmod'
	$(CC) -o $(CONFIG)/bin/ejsmod -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsmod.o $(CONFIG)/obj/doc.o $(CONFIG)/obj/docFiles.o $(CONFIG)/obj/listing.o $(CONFIG)/obj/slotGen.o $(LIBS_110) $(LIBS_110) $(LIBS) -lpam
...
$(CONFIG)/bin/ejsrun: $(DEPS_112)
	@echo '      [Link] ejsrun'
	$(CC) -o $(CONFIG)/bin/ejsrun -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_112) $(LIBS_112) $(LIBS) -lpam
...
$(CONFIG)/bin/jem: $(DEPS_116)
	@echo '      [Link] jem'
	$(CC) -o $(CONFIG)/bin/jem -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_116) $(LIBS_116) $(LIBS) -lpam
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_121 += $(CONFIG)/bin/libsqlite3.dylib
endif
...
$(CONFIG)/bin/libejs.db.sqlite.dylib: $(DEPS_121)
	@echo '      [Link] libejs.db.sqlite'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.db.sqlite.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libejs.db.sqlite.dylib $(CONFIG)/obj/ejsSqlite.o $(LIBS_121) $(LIBS_121) $(LIBS) -lpam
...
$(CONFIG)/bin/libejs.web.dylib: $(DEPS_128)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.web.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libejs.web.dylib $(CONFIG)/obj/ejsHttpServer.o $(CONFIG)/obj/ejsRequest.o $(CONFIG)/obj/ejsSession.o $(CONFIG)/obj/ejsWeb.o $(LIBS_128) $(LIBS_128) $(LIBS) -lpam
...
$(CONFIG)/bin/libejs.zlib.dylib: $(DEPS_133)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.zlib.dylib $(LDFLAGS) -compatibility_version 2.3.0 -current_version 2.3.0 $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib $(CONFIG)/obj/ejsZlib.o $(LIBS_133) $(LIBS_133) $(LIBS) -lpam
...
$(CONFIG)/bin/mvc: $(DEPS_136)
	@echo '      [Link] mvc'
	$(CC) -o $(CONFIG)/bin/mvc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_136) $(LIBS_136) $(LIBS) -lpam
...
$(CONFIG)/bin/utest: $(DEPS_140)
	@echo '      [Link] utest'
	$(CC) -o $(CONFIG)/bin/utest -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_140) $(LIBS_140) $(LIBS) -lpam
