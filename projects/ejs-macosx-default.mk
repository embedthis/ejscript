...
$(CONFIG)/bin/ejsman: $(DEPS_8)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/ejsman -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_8) $(LIBS_8) $(LIBS)
...
$(CONFIG)/bin/makerom: $(DEPS_10)
	@echo '      [Link] makerom'
	$(CC) -o $(CONFIG)/bin/makerom -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBS_10) $(LIBS_10) $(LIBS)
...
$(CONFIG)/bin/http: $(DEPS_22)
	@echo '      [Link] http'
	$(CC) -o $(CONFIG)/bin/http -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/http.o $(LIBS_22) $(LIBS_22) $(LIBS) -lpam
...
$(CONFIG)/bin/ejs: $(DEPS_102)
	@echo '      [Link] ejs'
	$(CC) -o $(CONFIG)/bin/ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS_102) $(LIBS_102) $(LIBS) -ledit
...
$(CONFIG)/bin/ejsc: $(DEPS_104)
	@echo '      [Link] ejsc'
	$(CC) -o $(CONFIG)/bin/ejsc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBS_104) $(LIBS_104) $(LIBS) -lpam
...
$(CONFIG)/bin/ejsmod: $(DEPS_111)
	@echo '      [Link] ejsmod'
	$(CC) -o $(CONFIG)/bin/ejsmod -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsmod.o $(CONFIG)/obj/doc.o $(CONFIG)/obj/docFiles.o $(CONFIG)/obj/listing.o $(CONFIG)/obj/slotGen.o $(LIBS_111) $(LIBS_111) $(LIBS) -lpam
...
$(CONFIG)/bin/ejsrun: $(DEPS_113)
	@echo '      [Link] ejsrun'
	$(CC) -o $(CONFIG)/bin/ejsrun -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_113) $(LIBS_113) $(LIBS) -lpam
...
$(CONFIG)/bin/jem: $(DEPS_117)
	@echo '      [Link] jem'
	$(CC) -o $(CONFIG)/bin/jem -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_117) $(LIBS_117) $(LIBS) -lpam
