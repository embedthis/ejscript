...
$(CONFIG)/bin/ejsrun: $(DEPS_98)
	...
	$(CC) -o $(CONFIG)/bin/ejsrun -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_98) $(LIBS_98) $(LIBS_98) $(LIBS) -lpam 
...
$(CONFIG)/bin/http: $(DEPS_100)
	...
	$(CC) -o $(CONFIG)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_100) $(LIBS_100) $(LIBS_100) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libejs.web.dylib: $(DEPS_106)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.web.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.web.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_106) $(LIBS_106) $(LIBS_106) $(LIBS) -lpam 
...
$(CONFIG)/bin/libzlib.dylib: $(DEPS_109)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_111 += $(CONFIG)/bin/libzlib.dylib
endif
...
$(CONFIG)/bin/libejs.zlib.dylib: $(DEPS_111)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.zlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_111) $(LIBS_111) $(LIBS_111) $(LIBS) -lpam 
...
$(CONFIG)/bin/libest.dylib: $(DEPS_114)
...
ifeq ($(ME_COM_EST),1)
    DEPS_116 += $(CONFIG)/bin/libest.dylib
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_116)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libmprssl.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_116) $(LIBS_116) $(LIBS_116) $(LIBS) 
...
$(CONFIG)/bin/libsql.dylib: $(DEPS_119)
...
$(CONFIG)/bin/ejsman: $(DEPS_121)
	...
	$(CC) -o $(CONFIG)/bin/ejsman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_121) $(LIBS_121) $(LIBS_121) $(LIBS) 
...
$(CONFIG)/bin/mvc: $(DEPS_122)
	...
	$(CC) -o $(CONFIG)/bin/mvc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_122) $(LIBS_122) $(LIBS_122) $(LIBS) -lpam 
...
$(CONFIG)/bin/sqlite: $(DEPS_124)
	...
	$(CC) -o $(CONFIG)/bin/sqlite -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_124) $(LIBS_124) $(LIBS_124) $(LIBS) 
endif
...
$(CONFIG)/bin/utest: $(DEPS_125)
	...
	$(CC) -o $(CONFIG)/bin/utest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_125) $(LIBS_125) $(LIBS_125) $(LIBS) -lpam 
