...
$(BUILD)/bin/libmpr.dylib: $(DEPS_114)
	@echo '      [Link] $(BUILD)/bin/libmpr.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmpr.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_114) $(LIBS_114) $(LIBS_114) $(LIBS) 
...
$(BUILD)/bin/libpcre.dylib: $(DEPS_115)
...
#   libhttp
#
DEPS_116 += $(BUILD)/bin/libmpr.dylib
ifeq ($(ME_COM_PCRE),1)
    DEPS_116 += $(BUILD)/bin/libpcre.dylib
endif
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_116)
	@echo '      [Link] $(BUILD)/bin/libhttp.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libhttp.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_116) $(LIBS_116) $(LIBS_116) $(LIBS) -lpam 
endif
...
DEPS_117 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_117 += $(BUILD)/bin/libhttp.dylib
endif
...
$(BUILD)/bin/ejs: $(DEPS_118)
	@echo '      [Link] $(BUILD)/bin/ejs'
	$(CC) -o $(BUILD)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejs.o" $(LIBPATHS_118) $(LIBS_118) $(LIBS_118) $(LIBS) -lpam -ledit 
...
$(BUILD)/bin/ejsc: $(DEPS_119)
	@echo '      [Link] $(BUILD)/bin/ejsc'
	$(CC) -o $(BUILD)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsc.o" $(LIBPATHS_119) $(LIBS_119) $(LIBS_119) $(LIBS) -lpam 
...
$(BUILD)/bin/ejsmod: $(DEPS_120)
	@echo '      [Link] $(BUILD)/bin/ejsmod'
	$(CC) -o $(BUILD)/bin/ejsmod -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_120) $(LIBS_120) $(LIBS_120) $(LIBS) -lpam 
...
DEPS_121 += $(BUILD)/bin/ejsc
DEPS_121 += $(BUILD)/bin/ejsmod
...
$(BUILD)/bin/libzlib.dylib: $(DEPS_131)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_132 += $(BUILD)/bin/libzlib.dylib
endif
...
$(BUILD)/bin/libejs.zlib.dylib: $(DEPS_132)
	@echo '      [Link] $(BUILD)/bin/libejs.zlib.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.zlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/ejsZlib.o" $(LIBPATHS_132) $(LIBS_132) $(LIBS_132) $(LIBS) -lpam 
...
DEPS_133 += $(BUILD)/bin/libejs.zlib.dylib
...
$(BUILD)/bin/ejsrun: $(DEPS_134)
	...
	$(CC) -o $(BUILD)/bin/ejsrun -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_134) $(LIBS_134) $(LIBS_134) $(LIBS) -lpam 
...
$(BUILD)/bin/libsql.dylib: $(DEPS_136)
...
$(BUILD)/bin/libejs.db.sqlite.dylib: $(DEPS_137)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.db.sqlite.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.db.sqlite.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_137) $(LIBS_137) $(LIBS_137) $(LIBS) -lpam 

#
#   libejs.web
#
DEPS_138 += $(BUILD)/bin/libejs.dylib
...
$(BUILD)/bin/libejs.web.dylib: $(DEPS_138)
	@echo '      [Link] $(BUILD)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.web.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.web.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_138) $(LIBS_138) $(LIBS_138) $(LIBS) -lpam 
...
$(BUILD)/bin/mvc: $(DEPS_140)
	@echo '      [Link] $(BUILD)/bin/mvc'
	$(CC) -o $(BUILD)/bin/mvc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_140) $(LIBS_140) $(LIBS_140) $(LIBS) -lpam 
...
$(BUILD)/bin/utest: $(DEPS_143)
	@echo '      [Link] $(BUILD)/bin/utest'
	$(CC) -o $(BUILD)/bin/utest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_143) $(LIBS_143) $(LIBS_143) $(LIBS) -lpam 
