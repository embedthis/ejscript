...
ifeq ($(ME_COM_SQLITE),1)
    DEPS_113 += $(CONFIG)/bin/libsql.dylib
endif
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_124 += $(CONFIG)/bin/libzlib.dylib
endif
...
ifeq ($(ME_COM_EST),1)
    DEPS_129 += $(CONFIG)/bin/libest.dylib
endif
...
DEPS_135 += $(CONFIG)/bin/libsql.dylib
