...
$(BUILD)/bin/libzlib.dylib: $(DEPS_139)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_140 += $(BUILD)/bin/libzlib.dylib
endif
...
$(BUILD)/bin/libejs.zlib.dylib: $(DEPS_140)
	@echo '      [Link] $(BUILD)/bin/libejs.zlib.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.zlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/ejsZlib.o" $(LIBPATHS_140) $(LIBS_140) $(LIBS_140) $(LIBS) -lpam 
...
$(BUILD)/bin/libmprssl.dylib: $(DEPS_141)
	@echo '      [Link] $(BUILD)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libmprssl.dylib -compatibility_version 2.5 -current_version 2.5 "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_141) $(LIBS_141) $(LIBS_141) $(LIBS) 

#
#   manager
#
DEPS_142 += $(BUILD)/bin/libmpr.dylib
...
$(BUILD)/bin/ejsman: $(DEPS_142)
	...
	$(CC) -o $(BUILD)/bin/ejsman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) 
...
$(BUILD)/bin/mvc: $(DEPS_144)
	...
	$(CC) -o $(BUILD)/bin/mvc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) -lpam 
...
$(BUILD)/bin/utest: $(DEPS_147)
	...
	$(CC) -o $(BUILD)/bin/utest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_147) $(LIBS_147) $(LIBS_147) $(LIBS) -lpam 
