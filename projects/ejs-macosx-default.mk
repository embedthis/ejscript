...
$(CONFIG)/bin/libmpr.dylib: $(DEPS_6)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmpr.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/mprLib.o" $(LIBS) 
...
$(CONFIG)/bin/libest.dylib: $(DEPS_9)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libest.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libest.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/estLib.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_11)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_11) $(LIBS_11) $(LIBS_11) $(LIBS) 
...
$(CONFIG)/bin/ejsman: $(DEPS_13)
	...
	$(CC) -o $(CONFIG)/bin/ejsman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_13) $(LIBS_13) $(LIBS_13) $(LIBS) 
...
$(CONFIG)/bin/libpcre.dylib: $(DEPS_19)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libpcre.dylib -arch $(CC_ARCH) $(LDFLAGS) -compatibility_version 2.3.2 -current_version 2.3.2 $(LIBPATHS) -install_name @rpath/libpcre.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/pcre.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_22)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) -lpam 
...
$(CONFIG)/bin/libsqlite3.dylib: $(DEPS_27)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libsqlite3.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libsqlite3.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/sqlite3.o" $(LIBS) 
endif
...
$(CONFIG)/obj/zlib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/zlib.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/zlib/zlib.c
...
$(CONFIG)/bin/libzlib.dylib: $(DEPS_32)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libzlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libzlib.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/zlib.o" $(LIBS) 
endif
...
$(CONFIG)/obj/ecAst.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecAst.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecAst.c
...
$(CONFIG)/obj/ecCodeGen.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecCodeGen.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecCodeGen.c
...
$(CONFIG)/obj/ecCompiler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecCompiler.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecCompiler.c
...
$(CONFIG)/obj/ecLex.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecLex.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecLex.c
...
$(CONFIG)/obj/ecModuleWrite.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecModuleWrite.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecModuleWrite.c
...
$(CONFIG)/obj/ecParser.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecParser.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecParser.c
...
$(CONFIG)/obj/ecState.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ecState.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/compiler/ecState.c
...
$(CONFIG)/obj/dtoa.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/dtoa.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/dtoa.c
...
$(CONFIG)/obj/ejsApp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsApp.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsApp.c
...
$(CONFIG)/obj/ejsArray.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsArray.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsArray.c
...
$(CONFIG)/obj/ejsBlock.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsBlock.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsBlock.c
...
$(CONFIG)/obj/ejsBoolean.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsBoolean.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsBoolean.c
...
$(CONFIG)/obj/ejsByteArray.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsByteArray.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsByteArray.c
...
$(CONFIG)/obj/ejsCache.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsCache.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsCache.c
...
$(CONFIG)/obj/ejsCmd.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsCmd.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsCmd.c
...
$(CONFIG)/obj/ejsConfig.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsConfig.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsConfig.c
...
$(CONFIG)/obj/ejsDate.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsDate.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsDate.c
...
$(CONFIG)/obj/ejsDebug.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsDebug.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsDebug.c
...
$(CONFIG)/obj/ejsError.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsError.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsError.c
...
$(CONFIG)/obj/ejsFile.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsFile.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsFile.c
...
$(CONFIG)/obj/ejsFileSystem.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsFileSystem.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsFileSystem.c
...
$(CONFIG)/obj/ejsFrame.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsFrame.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsFrame.c
...
$(CONFIG)/obj/ejsFunction.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsFunction.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsFunction.c
...
$(CONFIG)/obj/ejsGC.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsGC.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsGC.c
...
$(CONFIG)/obj/ejsGlobal.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsGlobal.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsGlobal.c
...
$(CONFIG)/obj/ejsHttp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsHttp.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsHttp.c
...
$(CONFIG)/obj/ejsIterator.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsIterator.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsIterator.c
...
$(CONFIG)/obj/ejsJSON.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsJSON.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsJSON.c
...
$(CONFIG)/obj/ejsLocalCache.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsLocalCache.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsLocalCache.c
...
$(CONFIG)/obj/ejsMath.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsMath.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsMath.c
...
$(CONFIG)/obj/ejsMemory.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsMemory.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsMemory.c
...
$(CONFIG)/obj/ejsMprLog.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsMprLog.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsMprLog.c
...
$(CONFIG)/obj/ejsNamespace.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsNamespace.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsNamespace.c
...
$(CONFIG)/obj/ejsNull.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsNull.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsNull.c
...
$(CONFIG)/obj/ejsNumber.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsNumber.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsNumber.c
...
$(CONFIG)/obj/ejsObject.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsObject.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsObject.c
...
$(CONFIG)/obj/ejsPath.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsPath.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsPath.c
...
$(CONFIG)/obj/ejsPot.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsPot.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsPot.c
...
$(CONFIG)/obj/ejsRegExp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsRegExp.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsRegExp.c
...
$(CONFIG)/obj/ejsSocket.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsSocket.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsSocket.c
...
$(CONFIG)/obj/ejsString.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsString.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsString.c
...
$(CONFIG)/obj/ejsSystem.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsSystem.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsSystem.c
...
$(CONFIG)/obj/ejsTimer.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsTimer.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsTimer.c
...
$(CONFIG)/obj/ejsType.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsType.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsType.c
...
$(CONFIG)/obj/ejsUri.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsUri.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsUri.c
...
$(CONFIG)/obj/ejsVoid.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsVoid.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsVoid.c
...
$(CONFIG)/obj/ejsWebSocket.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsWebSocket.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsWebSocket.c
...
$(CONFIG)/obj/ejsWorker.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsWorker.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsWorker.c
...
$(CONFIG)/obj/ejsXML.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsXML.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsXML.c
...
$(CONFIG)/obj/ejsXMLList.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsXMLList.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsXMLList.c
...
$(CONFIG)/obj/ejsXMLLoader.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsXMLLoader.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/core/src/ejsXMLLoader.c
...
$(CONFIG)/obj/ejsByteCode.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsByteCode.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsByteCode.c
...
$(CONFIG)/obj/ejsException.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsException.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsException.c
...
$(CONFIG)/obj/ejsHelper.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsHelper.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsHelper.c
...
$(CONFIG)/obj/ejsInterp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsInterp.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsInterp.c
...
$(CONFIG)/obj/ejsLoader.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsLoader.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsLoader.c
...
$(CONFIG)/obj/ejsModule.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsModule.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsModule.c
...
$(CONFIG)/obj/ejsScope.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsScope.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsScope.c
...
$(CONFIG)/obj/ejsService.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsService.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/vm/ejsService.c
...
$(CONFIG)/obj/ejs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejs.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/cmd/ejs.c
...
$(CONFIG)/bin/ejs: $(DEPS_104)
	...
	$(CC) -o $(CONFIG)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_104) $(LIBS_104) $(LIBS_104) $(LIBS) -lpam -ledit 
...
$(CONFIG)/obj/ejsc.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsc.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/cmd/ejsc.c
...
$(CONFIG)/bin/ejsc: $(DEPS_106)
	...
	$(CC) -o $(CONFIG)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_106) $(LIBS_106) $(LIBS_106) $(LIBS) -lpam 
...
$(CONFIG)/obj/ejsmod.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsmod.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/cmd/ejsmod.c
...
$(CONFIG)/obj/doc.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/doc.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/cmd/doc.c
...
$(CONFIG)/obj/docFiles.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/docFiles.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/cmd/docFiles.c
...
$(CONFIG)/obj/listing.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/listing.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/cmd/listing.c
...
$(CONFIG)/obj/slotGen.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/slotGen.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/cmd/slotGen.c
...
$(CONFIG)/bin/ejsmod: $(DEPS_113)
	...
	$(CC) -o $(CONFIG)/bin/ejsmod -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsmod.o" "$(CONFIG)/obj/doc.o" "$(CONFIG)/obj/docFiles.o" "$(CONFIG)/obj/listing.o" "$(CONFIG)/obj/slotGen.o" $(LIBPATHS_113) $(LIBS_113) $(LIBS_113) $(LIBS) -lpam 
...
$(CONFIG)/obj/ejsrun.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsrun.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/cmd/ejsrun.c
...
$(CONFIG)/bin/ejsrun: $(DEPS_115)
	...
	$(CC) -o $(CONFIG)/bin/ejsrun -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_115) $(LIBS_115) $(LIBS_115) $(LIBS) -lpam 
...
DEPS_116 += $(CONFIG)/bin/libejs.dylib
...
DEPS_119 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/bin/jem: $(DEPS_119)
	...
	$(CC) -o $(CONFIG)/bin/jem -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_119) $(LIBS_119) $(LIBS_119) $(LIBS) -lpam 
...
DEPS_120 += $(CONFIG)/bin/libejs.dylib
...
DEPS_121 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/obj/ejsSqlite.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsSqlite.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/jems/ejs.db.sqlite/ejsSqlite.c
...
$(CONFIG)/bin/libejs.db.sqlite.dylib: $(DEPS_124)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.db.sqlite.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.db.sqlite.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/ejsSqlite.o" $(LIBPATHS_124) $(LIBS_124) $(LIBS_124) $(LIBS) -lpam 
...
DEPS_126 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/obj/ejsHttpServer.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsHttpServer.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/jems/ejs.web/ejsHttpServer.c
...
$(CONFIG)/obj/ejsRequest.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsRequest.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/jems/ejs.web/ejsRequest.c
...
$(CONFIG)/obj/ejsSession.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsSession.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/jems/ejs.web/ejsSession.c
...
$(CONFIG)/obj/ejsWeb.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsWeb.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/jems/ejs.web/ejsWeb.c
...
$(CONFIG)/bin/libejs.web.dylib: $(DEPS_132)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.web.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.web.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_132) $(LIBS_132) $(LIBS_132) $(LIBS) -lpam 
...
DEPS_134 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/obj/ejsZlib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsZlib.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-Isrc/cmd" src/jems/ejs.zlib/ejsZlib.c
...
ifeq ($(BIT_PACK_ZLIB),1)
    DEPS_137 += $(CONFIG)/bin/libzlib.dylib
endif
...
$(CONFIG)/bin/libejs.zlib.dylib: $(DEPS_137)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.zlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.3.2 -current_version 2.3.2 "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_137) $(LIBS_137) $(LIBS_137) $(LIBS) -lpam 
...
DEPS_140 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/bin/mvc: $(DEPS_140)
	...
	$(CC) -o $(CONFIG)/bin/mvc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_140) $(LIBS_140) $(LIBS_140) $(LIBS) -lpam 
...
DEPS_141 += $(CONFIG)/bin/libejs.dylib
...
DEPS_144 += $(CONFIG)/bin/libejs.dylib
...
$(CONFIG)/bin/utest: $(DEPS_144)
	...
	$(CC) -o $(CONFIG)/bin/utest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) -lpam 
