...
$(CONFIG)/bin/http: $(DEPS_100)
	...
	$(CC) -o $(CONFIG)/bin/http -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_100) $(LIBS_100) $(LIBS_100) $(LIBS) -lpam 
endif

#
#   sqlite3.h
#
$(CONFIG)/inc/sqlite3.h: $(DEPS_101)
...
#   libsql
#
DEPS_103 += $(CONFIG)/inc/sqlite3.h
DEPS_103 += $(CONFIG)/inc/me.h
DEPS_103 += $(CONFIG)/obj/sqlite3.o

$(CONFIG)/bin/libsql.dylib: $(DEPS_103)
...
$(CONFIG)/obj/ejsSqlite.o: \
    src/ejs.db.sqlite/ejsSqlite.c $(DEPS_104)
...
DEPS_105 += $(CONFIG)/bin/ejsc
DEPS_105 += src/cmd/ejsmod.h
DEPS_105 += $(CONFIG)/obj/ejsmod.o
DEPS_105 += $(CONFIG)/obj/doc.o
DEPS_105 += $(CONFIG)/obj/docFiles.o
DEPS_105 += $(CONFIG)/obj/listing.o
DEPS_105 += $(CONFIG)/obj/slotGen.o
DEPS_105 += $(CONFIG)/bin/ejsmod
DEPS_105 += $(CONFIG)/bin/ejs.mod
DEPS_105 += $(CONFIG)/bin/ejs.db.sqlite.mod
DEPS_105 += $(CONFIG)/inc/sqlite3.h
DEPS_105 += $(CONFIG)/obj/sqlite3.o
ifeq ($(ME_COM_SQLITE),1)
    DEPS_105 += $(CONFIG)/bin/libsql.dylib
endif
DEPS_105 += $(CONFIG)/obj/ejsSqlite.o
...
$(CONFIG)/bin/libejs.db.sqlite.dylib: $(DEPS_105)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.db.sqlite.dylib -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS) -install_name @rpath/libejs.db.sqlite.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/ejsSqlite.o" $(LIBPATHS_105) $(LIBS_105) $(LIBS_105) $(LIBS) -lpam 

#
#   ejsWeb.h
#
$(CONFIG)/inc/ejsWeb.h: $(DEPS_106)
...
DEPS_107 += $(CONFIG)/inc/mpr.h
DEPS_107 += $(CONFIG)/inc/http.h
DEPS_107 += $(CONFIG)/inc/ejsByteCode.h
DEPS_107 += $(CONFIG)/inc/ejsByteCodeTable.h
DEPS_107 += $(CONFIG)/inc/ejs.slots.h
DEPS_107 += $(CONFIG)/inc/ejsCustomize.h
DEPS_107 += $(CONFIG)/inc/ejs.h
DEPS_107 += $(CONFIG)/inc/ejsCompiler.h
DEPS_107 += $(CONFIG)/inc/ejsWeb.h
DEPS_107 += $(CONFIG)/inc/ejs.web.slots.h

$(CONFIG)/obj/ejsHttpServer.o: \
    src/ejs.web/ejsHttpServer.c $(DEPS_107)
...
DEPS_108 += $(CONFIG)/inc/ejsWeb.h
DEPS_108 += $(CONFIG)/inc/ejs.web.slots.h

$(CONFIG)/obj/ejsRequest.o: \
    src/ejs.web/ejsRequest.c $(DEPS_108)
...
DEPS_109 += $(CONFIG)/inc/ejsWeb.h

$(CONFIG)/obj/ejsSession.o: \
    src/ejs.web/ejsSession.c $(DEPS_109)
...
DEPS_110 += $(CONFIG)/inc/ejsWeb.h
DEPS_110 += $(CONFIG)/inc/ejs.web.slots.h

$(CONFIG)/obj/ejsWeb.o: \
    src/ejs.web/ejsWeb.c $(DEPS_110)
...
DEPS_111 += $(CONFIG)/inc/ejsWeb.h
DEPS_111 += $(CONFIG)/obj/ejsHttpServer.o
DEPS_111 += $(CONFIG)/obj/ejsRequest.o
DEPS_111 += $(CONFIG)/obj/ejsSession.o
DEPS_111 += $(CONFIG)/obj/ejsWeb.o
...
$(CONFIG)/bin/libejs.web.dylib: $(DEPS_111)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.web.dylib -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS) -install_name @rpath/libejs.web.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_111) $(LIBS_111) $(LIBS_111) $(LIBS) -lpam 

#
#   zlib.h
#
$(CONFIG)/inc/zlib.h: $(DEPS_112)
...
#   libzlib
#
DEPS_114 += $(CONFIG)/inc/zlib.h
DEPS_114 += $(CONFIG)/inc/me.h
DEPS_114 += $(CONFIG)/obj/zlib.o

$(CONFIG)/bin/libzlib.dylib: $(DEPS_114)
...
DEPS_115 += $(CONFIG)/inc/zlib.h
DEPS_115 += $(CONFIG)/inc/ejs.zlib.slots.h

$(CONFIG)/obj/ejsZlib.o: \
    src/ejs.zlib/ejsZlib.c $(DEPS_115)
...
DEPS_116 += $(CONFIG)/bin/ejs.zlib.mod
DEPS_116 += $(CONFIG)/inc/zlib.h
DEPS_116 += $(CONFIG)/obj/zlib.o
ifeq ($(ME_COM_ZLIB),1)
    DEPS_116 += $(CONFIG)/bin/libzlib.dylib
endif
DEPS_116 += $(CONFIG)/obj/ejsZlib.o
...
$(CONFIG)/bin/libejs.zlib.dylib: $(DEPS_116)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.zlib.dylib -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS) -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_116) $(LIBS_116) $(LIBS_116) $(LIBS) -lpam 

#
#   est.h
#
$(CONFIG)/inc/est.h: $(DEPS_117)
...
DEPS_118 += $(CONFIG)/inc/est.h
DEPS_118 += $(CONFIG)/inc/osdep.h

$(CONFIG)/obj/estLib.o: \
    src/paks/est/estLib.c $(DEPS_118)
...
#   libest
#
DEPS_119 += $(CONFIG)/inc/est.h
DEPS_119 += $(CONFIG)/inc/me.h
DEPS_119 += $(CONFIG)/inc/osdep.h
DEPS_119 += $(CONFIG)/obj/estLib.o

$(CONFIG)/bin/libest.dylib: $(DEPS_119)
...
DEPS_120 += $(CONFIG)/inc/est.h

$(CONFIG)/obj/mprSsl.o: \
    src/paks/mpr/mprSsl.c $(DEPS_120)
...
DEPS_121 += $(CONFIG)/inc/est.h
DEPS_121 += $(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_121 += $(CONFIG)/bin/libest.dylib
endif
DEPS_121 += $(CONFIG)/obj/mprSsl.o
...
ifeq ($(ME_COM_MATRIXSSL),1)
    LIBS_121 += -lmatrixssl
    LIBPATHS_121 += -L$(ME_COM_MATRIXSSL_PATH)
endif
ifeq ($(ME_COM_NANOSSL),1)
    LIBS_121 += -lssls
    LIBPATHS_121 += -L$(ME_COM_NANOSSL_PATH)/bin
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_121 += -lssl
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_121)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) -Wl,-rpath,@executable_path/ -Wl,-rpath,@loader_path/ $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 2.3.5 -current_version 2.3.5 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_121) $(LIBS_121) $(LIBS_121) $(LIBS) 
...
DEPS_126 += $(CONFIG)/bin/libsql.dylib
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_127 += $(CONFIG)/bin/libpcre.dylib
endif
DEPS_127 += $(CONFIG)/inc/http.h
DEPS_127 += $(CONFIG)/obj/httpLib.o
ifeq ($(ME_COM_HTTP),1)
    DEPS_127 += $(CONFIG)/bin/libhttp.dylib
endif
...
DEPS_127 += $(CONFIG)/bin/libejs.dylib
