#
#   linux-x86-debug.mk -- Build It Makefile to build Embedthis Ejscript for linux on x86
#
...
CC       := gcc
LD       := ld
CFLAGS   := -Wall -fPIC -g -Wno-unused-result -mtune=x86
...
$(CONFIG)/obj/sqlite3.o: \
        ...
        $(CONFIG)/inc/bit.h
	$(CC) -c -o $(CONFIG)/obj/sqlite3.o -fPIC -g -Wno-unused-result -mtune=x86 -w -w $(DFLAGS) -I$(CONFIG)/inc src/deps/sqlite/sqlite3.c
...
$(CONFIG)/bin/utest:  \
	...
	cp -r linux-x86-debug/bin/ejsrun $(CONFIG)/bin/utest
...
$(CONFIG)/bin/jem:  \
	...
	cp -r linux-x86-debug/bin/ejsrun $(CONFIG)/bin/jem
...
$(CONFIG)/bin/mvc:  \
	...
	cp -r linux-x86-debug/bin/ejsrun $(CONFIG)/bin/mvc
