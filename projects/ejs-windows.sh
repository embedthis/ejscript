#
#   ejs-windows.sh -- Build It Shell Script to build Embedthis Ejscript
#
...
"${CC}" -c -Fo${CONFIG}\obj\mprSsl.obj -Fd${CONFIG}\obj\mprSsl.pdb ${CFLAGS} ${DFLAGS} -DWIN32 -DMATRIX_USE_FILE_SYSTEM -I${CONFIG}\inc -I../packages-windows-x86/openssl/openssl-1.0.1b/inc32 -I../packages-windows-x86/matrixssl/matrixssl-3-3-open/matrixssl -I../packages-windows-x86/matrixssl/matrixssl-3-3-open src/deps/mpr/mprSsl.c

"${LD}" -dll -out:${CONFIG}\bin\libmprssl.dll -entry:_DllMainCRTStartup@12 -def:${CONFIG}\bin\libmprssl.def ${LDFLAGS} ${LIBPATHS} -libpath:../packages-windows-x86/openssl/openssl-1.0.1b/out32dll -libpath:../packages-windows-x86/matrixssl/matrixssl-3-3-open/Release ${CONFIG}\obj\mprSsl.obj ${LIBS} libmpr.lib libeay32.lib ssleay32.lib libmatrixssl.lib
...
"${CC}" -c -Fo${CONFIG}\obj\trees.obj -Fd${CONFIG}\obj\trees.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/trees.c
...
"${LD}" -out:${CONFIG}\bin\ejs.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejs.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib

"${CC}" -c -Fo${CONFIG}\obj\ejsc.obj -Fd${CONFIG}\obj\ejsc.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/cmd/ejsc.c

"${LD}" -out:${CONFIG}\bin\ejsc.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsc.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib
...
"${LD}" -out:${CONFIG}\bin\ejsmod.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsmod.obj ${CONFIG}\obj\doc.obj ${CONFIG}\obj\docFiles.obj ${CONFIG}\obj\listing.obj ${CONFIG}\obj\slotGen.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib

"${CC}" -c -Fo${CONFIG}\obj\ejsrun.obj -Fd${CONFIG}\obj\ejsrun.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/cmd/ejsrun.c

"${LD}" -out:${CONFIG}\bin\ejsrun.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsrun.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib
...
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/utest.es
rm -rf ${CONFIG}/bin/utest.exe
cp -r ${CONFIG}/bin/ejsrun.exe ${CONFIG}/bin/utest.exe

#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.unix.mod
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/jem.es
rm -rf ${CONFIG}/bin/jem.exe
cp -r ${CONFIG}/bin/ejsrun.exe ${CONFIG}/bin/jem.exe

#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.db.mod
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.db.mapper.mod
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.db.sqlite.mod
...
"${LD}" -dll -out:${CONFIG}\bin\ejs.db.sqlite.dll -entry:_DllMainCRTStartup@12 -def:${CONFIG}\bin\ejs.db.sqlite.def ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsSqlite.obj ${LIBS} libmpr.lib libejs.lib libhttp.lib libpcre.lib libsqlite3.lib
...
"${LD}" -dll -out:${CONFIG}\bin\ejs.web.dll -entry:_DllMainCRTStartup@12 -def:${CONFIG}\bin\ejs.web.def ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsHttpServer.obj ${CONFIG}\obj\ejsRequest.obj ${CONFIG}\obj\ejsSession.obj ${CONFIG}\obj\ejsWeb.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib
...
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.template.mod
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.tar.mod
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.zlib.mod
...
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/mvc.es
rm -rf ${CONFIG}/bin/mvc.exe
cp -r ${CONFIG}/bin/ejsrun.exe ${CONFIG}/bin/mvc.exe

#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/ejs.mvc.mod
#  Omit build script C:/cygwin/home/mob/ejs/windows-x86-debug/bin/utest.worker
