...
"${LD}" -dll -out:${CONFIG}/bin/ejs.zlib.dll -entry:_DllMainCRTStartup@12 -def:${CONFIG}/bin/ejs.zlib.def ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/ejsZlib.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib libzlib.lib
