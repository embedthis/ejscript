...
"${CC}" -c -Fo${CONFIG}\obj\mprSsl.obj -Fd${CONFIG}\obj\mprSsl.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc -I../packages-windows-x86/openssl/openssl-1.0.1b/inc32 src/deps/mpr/mprSsl.c
