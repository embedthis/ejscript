...
$(CONFIG)/bin/libhttp.so: $(DEPS_16)
	@echo '      [Link] $(CONFIG)/bin/libhttp.so'
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_16) $(LIBS_16) $(LIBS_16) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_20)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_20) $(LIBS_20) $(LIBS_20) $(LIBS) 
...
$(CONFIG)/bin/ejsman: $(DEPS_22)
	...
	$(CC) -o $(CONFIG)/bin/ejsman $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/sqlite: $(DEPS_27)
	...
	$(CC) -o $(CONFIG)/bin/sqlite $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_27) $(LIBS_27) $(LIBS_27) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_102)
	...
	$(CC) -o $(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_102) $(LIBS_102) $(LIBS_102) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/ejsc: $(DEPS_104)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_104) $(LIBS_104) $(LIBS_104) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/ejsmod: $(DEPS_111)
	...
	$(CC) -o $(CONFIG)/bin/ejsmod $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsmod.o" "$(CONFIG)/obj/doc.o" "$(CONFIG)/obj/docFiles.o" "$(CONFIG)/obj/listing.o" "$(CONFIG)/obj/slotGen.o" $(LIBPATHS_111) $(LIBS_111) $(LIBS_111) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/ejsrun: $(DEPS_113)
	...
	$(CC) -o $(CONFIG)/bin/ejsrun $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_113) $(LIBS_113) $(LIBS_113) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_120)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsSqlite.o" $(LIBPATHS_120) $(LIBS_120) $(LIBS_120) $(LIBS) 
...
ifeq ($(ME_EXT_PCRE),1)
    DEPS_121 += $(CONFIG)/bin/libpcre.so
endif
DEPS_121 += $(CONFIG)/inc/http.h
DEPS_121 += $(CONFIG)/obj/httpLib.o
DEPS_121 += $(CONFIG)/bin/libhttp.so
...
ifeq ($(ME_EXT_PCRE),1)
    DEPS_128 += $(CONFIG)/bin/libpcre.so
endif
DEPS_128 += $(CONFIG)/inc/http.h
DEPS_128 += $(CONFIG)/obj/httpLib.o
DEPS_128 += $(CONFIG)/bin/libhttp.so
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_128)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) 
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_133)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_133) $(LIBS_133) $(LIBS_133) $(LIBS) 
...
$(CONFIG)/bin/mvc: $(DEPS_136)
	...
	$(CC) -o $(CONFIG)/bin/mvc $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_136) $(LIBS_136) $(LIBS_136) $(LIBS) $(LIBS) 
