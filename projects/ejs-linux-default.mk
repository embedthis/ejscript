...
#   sqlite3.h
#
DEPS_24 += src/sqlite/sqlite3.h

$(BUILD)/inc/sqlite3.h: $(DEPS_24)
...
$(BUILD)/obj/ecCodeGen.o: \
    src/compiler/ecCodeGen.c $(DEPS_32)
...
$(BUILD)/obj/ecCompiler.o: \
    src/compiler/ecCompiler.c $(DEPS_33)
...
$(BUILD)/obj/ecModuleWrite.o: \
    src/compiler/ecModuleWrite.c $(DEPS_35)
...
$(BUILD)/obj/ecParser.o: \
    src/compiler/ecParser.c $(DEPS_36)
...
$(BUILD)/obj/ecState.o: \
    src/compiler/ecState.c $(DEPS_37)
...
DEPS_38 += $(BUILD)/inc/ejsCompiler.h

$(BUILD)/obj/ejs.o: \
    src/cmd/ejs.c $(DEPS_38)
...
$(BUILD)/obj/ejsArray.o: \
    src/core/src/ejsArray.c $(DEPS_40)
...
$(BUILD)/obj/ejsBlock.o: \
    src/core/src/ejsBlock.c $(DEPS_41)
...
$(BUILD)/obj/ejsBoolean.o: \
    src/core/src/ejsBoolean.c $(DEPS_42)
...
$(BUILD)/obj/ejsByteArray.o: \
    src/core/src/ejsByteArray.c $(DEPS_43)
...
$(BUILD)/obj/ejsCache.o: \
    src/core/src/ejsCache.c $(DEPS_45)
...
$(BUILD)/obj/ejsConfig.o: \
    src/core/src/ejsConfig.c $(DEPS_47)
...
$(BUILD)/obj/ejsDate.o: \
    src/core/src/ejsDate.c $(DEPS_48)
...
$(BUILD)/obj/ejsDebug.o: \
    src/core/src/ejsDebug.c $(DEPS_49)
...
$(BUILD)/obj/ejsError.o: \
    src/core/src/ejsError.c $(DEPS_50)
...
$(BUILD)/obj/ejsFile.o: \
    src/core/src/ejsFile.c $(DEPS_52)
...
$(BUILD)/obj/ejsFileSystem.o: \
    src/core/src/ejsFileSystem.c $(DEPS_53)
...
$(BUILD)/obj/ejsFrame.o: \
    src/core/src/ejsFrame.c $(DEPS_54)
...
$(BUILD)/obj/ejsFunction.o: \
    src/core/src/ejsFunction.c $(DEPS_55)
...
$(BUILD)/obj/ejsGlobal.o: \
    src/core/src/ejsGlobal.c $(DEPS_57)
...
$(BUILD)/obj/ejsHttp.o: \
    src/core/src/ejsHttp.c $(DEPS_59)
...
DEPS_61 += $(BUILD)/inc/ejsCompiler.h
DEPS_61 += src/ejs.web/ejsWeb.h
DEPS_61 += $(BUILD)/inc/ejs.web.slots.h

$(BUILD)/obj/ejsHttpServer.o: \
    src/ejs.web/ejsHttpServer.c $(DEPS_61)
...
$(BUILD)/obj/ejsLocalCache.o: \
    src/core/src/ejsLocalCache.c $(DEPS_66)
...
$(BUILD)/obj/ejsMath.o: \
    src/core/src/ejsMath.c $(DEPS_67)
...
$(BUILD)/obj/ejsMemory.o: \
    src/core/src/ejsMemory.c $(DEPS_68)
...
$(BUILD)/obj/ejsMprLog.o: \
    src/core/src/ejsMprLog.c $(DEPS_70)
...
$(BUILD)/obj/ejsNamespace.o: \
    src/core/src/ejsNamespace.c $(DEPS_71)
...
$(BUILD)/obj/ejsNull.o: \
    src/core/src/ejsNull.c $(DEPS_72)
...
$(BUILD)/obj/ejsNumber.o: \
    src/core/src/ejsNumber.c $(DEPS_73)
...
$(BUILD)/obj/ejsObject.o: \
    src/core/src/ejsObject.c $(DEPS_74)
...
$(BUILD)/obj/ejsPath.o: \
    src/core/src/ejsPath.c $(DEPS_75)
...
$(BUILD)/obj/ejsRegExp.o: \
    src/core/src/ejsRegExp.c $(DEPS_77)
...
DEPS_78 += $(BUILD)/inc/ejsCompiler.h
DEPS_78 += src/ejs.web/ejsWeb.h
DEPS_78 += $(BUILD)/inc/ejs.web.slots.h

$(BUILD)/obj/ejsRequest.o: \
    src/ejs.web/ejsRequest.c $(DEPS_78)
...
DEPS_81 += src/ejs.web/ejsWeb.h

$(BUILD)/obj/ejsSession.o: \
    src/ejs.web/ejsSession.c $(DEPS_81)
...
DEPS_83 += $(BUILD)/inc/ejs.db.sqlite.slots.h

$(BUILD)/obj/ejsSqlite.o: \
    src/ejs.db.sqlite/ejsSqlite.c $(DEPS_83)
...
#
DEPS_84 += src/ejs.h
DEPS_84 += $(BUILD)/inc/pcre.h

$(BUILD)/obj/ejsString.o: \
    src/core/src/ejsString.c $(DEPS_84)
...
$(BUILD)/obj/ejsSystem.o: \
    src/core/src/ejsSystem.c $(DEPS_85)
...
$(BUILD)/obj/ejsTimer.o: \
    src/core/src/ejsTimer.c $(DEPS_86)
...
$(BUILD)/obj/ejsType.o: \
    src/core/src/ejsType.c $(DEPS_87)
...
$(BUILD)/obj/ejsVoid.o: \
    src/core/src/ejsVoid.c $(DEPS_89)
...
DEPS_90 += $(BUILD)/inc/ejs.h
DEPS_90 += $(BUILD)/inc/ejsCompiler.h
DEPS_90 += src/ejs.web/ejsWeb.h
DEPS_90 += $(BUILD)/inc/ejs.web.slots.h

$(BUILD)/obj/ejsWeb.o: \
    src/ejs.web/ejsWeb.c $(DEPS_90)
...
#   ejsZlib.o
#
DEPS_96 += $(BUILD)/inc/ejs.h
DEPS_96 += $(BUILD)/inc/zlib.h
DEPS_96 += $(BUILD)/inc/ejs.zlib.slots.h

$(BUILD)/obj/ejsZlib.o: \
    src/ejs.zlib/ejsZlib.c $(DEPS_96)
...
src/est/est.h: $(DEPS_101)

#
#   estLib.o
#
DEPS_102 += src/est/est.h

$(BUILD)/obj/estLib.o: \
    src/est/estLib.c $(DEPS_102)
...
DEPS_105 += $(BUILD)/inc/pcre.h

$(BUILD)/obj/httpLib.o: \
    src/http/httpLib.c $(DEPS_105)
...
DEPS_106 += $(BUILD)/inc/ejsByteCodeTable.h

$(BUILD)/obj/listing.o: \
    src/cmd/listing.c $(DEPS_106)
...
src/mpr/mpr.h: $(DEPS_107)

#
#   mprLib.o
#
DEPS_108 += src/mpr/mpr.h

$(BUILD)/obj/mprLib.o: \
    src/mpr/mprLib.c $(DEPS_108)
...
$(BUILD)/obj/openssl.o: \
    src/mpr-openssl/openssl.c $(DEPS_109)
...
src/pcre/pcre.h: $(DEPS_110)

#
#   pcre.o
#
DEPS_111 += $(BUILD)/inc/me.h
DEPS_111 += src/pcre/pcre.h

$(BUILD)/obj/pcre.o: \
    src/pcre/pcre.c $(DEPS_111)
...
$(BUILD)/obj/watchdog.o: \
    src/watchdog/watchdog.c $(DEPS_116)
...
src/zlib/zlib.h: $(DEPS_117)

#
#   zlib.o
#
DEPS_118 += $(BUILD)/inc/me.h
DEPS_118 += src/zlib/zlib.h

$(BUILD)/obj/zlib.o: \
    src/zlib/zlib.c $(DEPS_118)
...
#   openssl
#
DEPS_120 += $(BUILD)/obj/openssl.o

$(BUILD)/bin/libmpr-openssl.a: $(DEPS_120)
...
DEPS_121 += $(BUILD)/inc/est.h
DEPS_121 += $(BUILD)/obj/estLib.o

$(BUILD)/bin/libest.a: $(DEPS_121)
...
#
ifeq ($(ME_COM_EST),1)
    DEPS_122 += $(BUILD)/bin/libest.a
endif
DEPS_122 += $(BUILD)/obj/est.o

$(BUILD)/bin/libmpr-estssl.a: $(DEPS_122)
...
#   libmpr
#
DEPS_123 += $(BUILD)/inc/osdep.h
ifeq ($(ME_COM_SSL),1)
ifeq ($(ME_COM_OPENSSL),1)
    DEPS_123 += $(BUILD)/bin/libmpr-openssl.a
endif
endif
ifeq ($(ME_COM_SSL),1)
ifeq ($(ME_COM_EST),1)
    DEPS_123 += $(BUILD)/bin/libmpr-estssl.a
endif
endif
DEPS_123 += $(BUILD)/inc/mpr.h
DEPS_123 += $(BUILD)/obj/mprLib.o
...
$(BUILD)/bin/libmpr.so: $(DEPS_123)
	@echo '      [Link] $(BUILD)/bin/libmpr.so'
	$(CC) -shared -o $(BUILD)/bin/libmpr.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprLib.o" $(LIBPATHS_123) $(LIBS_123) $(LIBS_123) $(LIBS) 

ifeq ($(ME_COM_PCRE),1)
#
#   libpcre
#
DEPS_124 += $(BUILD)/inc/pcre.h
DEPS_124 += $(BUILD)/obj/pcre.o

$(BUILD)/bin/libpcre.so: $(DEPS_124)
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_125 += $(BUILD)/bin/libpcre.so
endif
DEPS_125 += $(BUILD)/inc/http.h
DEPS_125 += $(BUILD)/obj/httpLib.o
...
$(BUILD)/bin/libhttp.so: $(DEPS_125)
	@echo '      [Link] $(BUILD)/bin/libhttp.so'
	$(CC) -shared -o $(BUILD)/bin/libhttp.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/httpLib.o" $(LIBPATHS_125) $(LIBS_125) $(LIBS_125) $(LIBS) 
endif
...
DEPS_126 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_126 += $(BUILD)/bin/libhttp.so
endif
DEPS_126 += $(BUILD)/inc/ejs.cache.local.slots.h
DEPS_126 += $(BUILD)/inc/ejs.db.sqlite.slots.h
DEPS_126 += $(BUILD)/inc/ejs.slots.h
DEPS_126 += $(BUILD)/inc/ejs.web.slots.h
DEPS_126 += $(BUILD)/inc/ejs.zlib.slots.h
DEPS_126 += $(BUILD)/inc/ejs.h
DEPS_126 += $(BUILD)/inc/ejsByteCode.h
DEPS_126 += $(BUILD)/inc/ejsByteCodeTable.h
DEPS_126 += $(BUILD)/inc/ejsCompiler.h
DEPS_126 += $(BUILD)/inc/ejsCustomize.h
DEPS_126 += $(BUILD)/obj/ecAst.o
DEPS_126 += $(BUILD)/obj/ecCodeGen.o
DEPS_126 += $(BUILD)/obj/ecCompiler.o
DEPS_126 += $(BUILD)/obj/ecLex.o
DEPS_126 += $(BUILD)/obj/ecModuleWrite.o
DEPS_126 += $(BUILD)/obj/ecParser.o
DEPS_126 += $(BUILD)/obj/ecState.o
DEPS_126 += $(BUILD)/obj/dtoa.o
DEPS_126 += $(BUILD)/obj/ejsApp.o
DEPS_126 += $(BUILD)/obj/ejsArray.o
DEPS_126 += $(BUILD)/obj/ejsBlock.o
DEPS_126 += $(BUILD)/obj/ejsBoolean.o
DEPS_126 += $(BUILD)/obj/ejsByteArray.o
DEPS_126 += $(BUILD)/obj/ejsCache.o
DEPS_126 += $(BUILD)/obj/ejsCmd.o
DEPS_126 += $(BUILD)/obj/ejsConfig.o
DEPS_126 += $(BUILD)/obj/ejsDate.o
DEPS_126 += $(BUILD)/obj/ejsDebug.o
DEPS_126 += $(BUILD)/obj/ejsError.o
DEPS_126 += $(BUILD)/obj/ejsFile.o
DEPS_126 += $(BUILD)/obj/ejsFileSystem.o
DEPS_126 += $(BUILD)/obj/ejsFrame.o
DEPS_126 += $(BUILD)/obj/ejsFunction.o
DEPS_126 += $(BUILD)/obj/ejsGC.o
DEPS_126 += $(BUILD)/obj/ejsGlobal.o
DEPS_126 += $(BUILD)/obj/ejsHttp.o
DEPS_126 += $(BUILD)/obj/ejsIterator.o
DEPS_126 += $(BUILD)/obj/ejsJSON.o
DEPS_126 += $(BUILD)/obj/ejsLocalCache.o
DEPS_126 += $(BUILD)/obj/ejsMath.o
DEPS_126 += $(BUILD)/obj/ejsMemory.o
DEPS_126 += $(BUILD)/obj/ejsMprLog.o
DEPS_126 += $(BUILD)/obj/ejsNamespace.o
DEPS_126 += $(BUILD)/obj/ejsNull.o
DEPS_126 += $(BUILD)/obj/ejsNumber.o
DEPS_126 += $(BUILD)/obj/ejsObject.o
DEPS_126 += $(BUILD)/obj/ejsPath.o
DEPS_126 += $(BUILD)/obj/ejsPot.o
DEPS_126 += $(BUILD)/obj/ejsRegExp.o
DEPS_126 += $(BUILD)/obj/ejsSocket.o
DEPS_126 += $(BUILD)/obj/ejsString.o
DEPS_126 += $(BUILD)/obj/ejsSystem.o
DEPS_126 += $(BUILD)/obj/ejsTimer.o
DEPS_126 += $(BUILD)/obj/ejsType.o
DEPS_126 += $(BUILD)/obj/ejsUri.o
DEPS_126 += $(BUILD)/obj/ejsVoid.o
DEPS_126 += $(BUILD)/obj/ejsWebSocket.o
DEPS_126 += $(BUILD)/obj/ejsWorker.o
DEPS_126 += $(BUILD)/obj/ejsXML.o
DEPS_126 += $(BUILD)/obj/ejsXMLList.o
DEPS_126 += $(BUILD)/obj/ejsXMLLoader.o
DEPS_126 += $(BUILD)/obj/ejsByteCode.o
DEPS_126 += $(BUILD)/obj/ejsException.o
DEPS_126 += $(BUILD)/obj/ejsHelper.o
DEPS_126 += $(BUILD)/obj/ejsInterp.o
DEPS_126 += $(BUILD)/obj/ejsLoader.o
DEPS_126 += $(BUILD)/obj/ejsModule.o
DEPS_126 += $(BUILD)/obj/ejsScope.o
DEPS_126 += $(BUILD)/obj/ejsService.o
...
$(BUILD)/bin/ejs: $(DEPS_127)
	@echo '      [Link] $(BUILD)/bin/ejs'
	$(CC) -o $(BUILD)/bin/ejs $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejs.o" $(LIBPATHS_127) $(LIBS_127) $(LIBS_127) $(LIBS) $(LIBS) 

#
#   ejsc
#
DEPS_128 += $(BUILD)/bin/libejs.so
DEPS_128 += $(BUILD)/obj/ejsc.o
...
$(BUILD)/bin/ejsc: $(DEPS_128)
	@echo '      [Link] $(BUILD)/bin/ejsc'
	$(CC) -o $(BUILD)/bin/ejsc $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsc.o" $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) $(LIBS) 

#
#   ejsmod
#
DEPS_129 += $(BUILD)/bin/libejs.so
DEPS_129 += $(BUILD)/inc/ejsmod.h
DEPS_129 += $(BUILD)/obj/ejsmod.o
DEPS_129 += $(BUILD)/obj/doc.o
DEPS_129 += $(BUILD)/obj/docFiles.o
DEPS_129 += $(BUILD)/obj/listing.o
DEPS_129 += $(BUILD)/obj/slotGen.o
...
$(BUILD)/bin/ejsmod: $(DEPS_129)
	@echo '      [Link] $(BUILD)/bin/ejsmod'
	$(CC) -o $(BUILD)/bin/ejsmod $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_129) $(LIBS_129) $(LIBS_129) $(LIBS) $(LIBS) 

#
#   ejs.mod
#
DEPS_130 += src/core/App.es
DEPS_130 += src/core/Args.es
DEPS_130 += src/core/Array.es
DEPS_130 += src/core/BinaryStream.es
DEPS_130 += src/core/Block.es
DEPS_130 += src/core/Boolean.es
DEPS_130 += src/core/ByteArray.es
DEPS_130 += src/core/Cache.es
DEPS_130 += src/core/Cmd.es
DEPS_130 += src/core/Compat.es
DEPS_130 += src/core/Config.es
DEPS_130 += src/core/Date.es
DEPS_130 += src/core/Debug.es
DEPS_130 += src/core/Emitter.es
DEPS_130 += src/core/Error.es
DEPS_130 += src/core/File.es
DEPS_130 += src/core/FileSystem.es
DEPS_130 += src/core/Frame.es
DEPS_130 += src/core/Function.es
DEPS_130 += src/core/GC.es
DEPS_130 += src/core/Global.es
DEPS_130 += src/core/Http.es
DEPS_130 += src/core/Inflector.es
DEPS_130 += src/core/Iterator.es
DEPS_130 += src/core/JSON.es
DEPS_130 += src/core/Loader.es
DEPS_130 += src/core/LocalCache.es
DEPS_130 += src/core/Locale.es
DEPS_130 += src/core/Logger.es
DEPS_130 += src/core/Math.es
DEPS_130 += src/core/Memory.es
DEPS_130 += src/core/MprLog.es
DEPS_130 += src/core/Name.es
DEPS_130 += src/core/Namespace.es
DEPS_130 += src/core/Null.es
DEPS_130 += src/core/Number.es
DEPS_130 += src/core/Object.es
DEPS_130 += src/core/Path.es
DEPS_130 += src/core/Promise.es
DEPS_130 += src/core/RegExp.es
DEPS_130 += src/core/Socket.es
DEPS_130 += src/core/Stream.es
DEPS_130 += src/core/String.es
DEPS_130 += src/core/System.es
DEPS_130 += src/core/TextStream.es
DEPS_130 += src/core/Timer.es
DEPS_130 += src/core/Type.es
DEPS_130 += src/core/Uri.es
DEPS_130 += src/core/Void.es
DEPS_130 += src/core/WebSocket.es
DEPS_130 += src/core/Worker.es
DEPS_130 += src/core/XML.es
DEPS_130 += src/core/XMLHttp.es
DEPS_130 += src/core/XMLList.es
DEPS_130 += $(BUILD)/bin/ejsc
DEPS_130 += $(BUILD)/bin/ejsmod

$(BUILD)/bin/ejs.mod: $(DEPS_130)
	( \
	cd src/core; \
...
#   ejs.db.mod
#
DEPS_131 += src/ejs.db/Database.es
DEPS_131 += src/ejs.db/DatabaseConnector.es
DEPS_131 += $(BUILD)/bin/ejsc
DEPS_131 += $(BUILD)/bin/ejs.mod

$(BUILD)/bin/ejs.db.mod: $(DEPS_131)
	( \
	cd src/ejs.db; \
...
#   ejs.db.mapper.mod
#
DEPS_132 += src/ejs.db.mapper/Record.es
DEPS_132 += $(BUILD)/bin/ejsc
DEPS_132 += $(BUILD)/bin/ejs.mod
DEPS_132 += $(BUILD)/bin/ejs.db.mod

$(BUILD)/bin/ejs.db.mapper.mod: $(DEPS_132)
	( \
...
#   ejs.db.sqlite.mod
#
DEPS_133 += src/ejs.db.sqlite/Sqlite.es
DEPS_133 += $(BUILD)/bin/ejsc
DEPS_133 += $(BUILD)/bin/ejsmod
DEPS_133 += $(BUILD)/bin/ejs.mod

$(BUILD)/bin/ejs.db.sqlite.mod: $(DEPS_133)
	( \
...
#   ejs.mail.mod
#
DEPS_134 += src/ejs.mail/Mail.es
DEPS_134 += $(BUILD)/bin/ejsc
DEPS_134 += $(BUILD)/bin/ejs.mod

$(BUILD)/bin/ejs.mail.mod: $(DEPS_134)
	( \
	cd src/ejs.mail; \
...
#   ejs.web.mod
#
DEPS_135 += src/ejs.web/Cascade.es
DEPS_135 += src/ejs.web/CommonLog.es
DEPS_135 += src/ejs.web/ContentType.es
DEPS_135 += src/ejs.web/Controller.es
DEPS_135 += src/ejs.web/Dir.es
DEPS_135 += src/ejs.web/Google.es
DEPS_135 += src/ejs.web/Head.es
DEPS_135 += src/ejs.web/Html.es
DEPS_135 += src/ejs.web/HttpServer.es
DEPS_135 += src/ejs.web/MethodOverride.es
DEPS_135 += src/ejs.web/Middleware.es
DEPS_135 += src/ejs.web/Mvc.es
DEPS_135 += src/ejs.web/Request.es
DEPS_135 += src/ejs.web/Router.es
DEPS_135 += src/ejs.web/Script.es
DEPS_135 += src/ejs.web/Session.es
DEPS_135 += src/ejs.web/ShowExceptions.es
DEPS_135 += src/ejs.web/Static.es
DEPS_135 += src/ejs.web/Template.es
DEPS_135 += src/ejs.web/UploadFile.es
DEPS_135 += src/ejs.web/UrlMap.es
DEPS_135 += src/ejs.web/Utils.es
DEPS_135 += src/ejs.web/View.es
DEPS_135 += $(BUILD)/bin/ejsc
DEPS_135 += $(BUILD)/bin/ejsmod
DEPS_135 += $(BUILD)/bin/ejs.mod

$(BUILD)/bin/ejs.web.mod: $(DEPS_135)
	( \
	cd src/ejs.web; \
...
#   ejs.template.mod
#
DEPS_136 += src/ejs.template/TemplateParser.es
DEPS_136 += $(BUILD)/bin/ejsc
DEPS_136 += $(BUILD)/bin/ejs.mod

$(BUILD)/bin/ejs.template.mod: $(DEPS_136)
	( \
	cd src/ejs.template; \
...
#   ejs.unix.mod
#
DEPS_137 += src/ejs.unix/Unix.es
DEPS_137 += $(BUILD)/bin/ejsc
DEPS_137 += $(BUILD)/bin/ejs.mod

$(BUILD)/bin/ejs.unix.mod: $(DEPS_137)
	( \
	cd src/ejs.unix; \
...
#   ejs.mvc.mod
#
DEPS_138 += src/ejs.mvc/mvc.es
DEPS_138 += $(BUILD)/bin/ejsc
DEPS_138 += $(BUILD)/bin/ejs.mod
DEPS_138 += $(BUILD)/bin/ejs.web.mod
DEPS_138 += $(BUILD)/bin/ejs.template.mod
DEPS_138 += $(BUILD)/bin/ejs.unix.mod

$(BUILD)/bin/ejs.mvc.mod: $(DEPS_138)
	( \
	cd src/ejs.mvc; \
...
$(BUILD)/bin/ejsrun: $(DEPS_143)
	@echo '      [Link] $(BUILD)/bin/ejsrun'
	$(CC) -o $(BUILD)/bin/ejsrun $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_143) $(LIBS_143) $(LIBS_143) $(LIBS) $(LIBS) 

ifeq ($(ME_COM_HTTP),1)
#
#   httpcmd
#
DEPS_144 += $(BUILD)/bin/libhttp.so
DEPS_144 += $(BUILD)/obj/http.o
...
$(BUILD)/bin/http: $(DEPS_144)
	@echo '      [Link] $(BUILD)/bin/http'
	$(CC) -o $(BUILD)/bin/http $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/http.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) $(LIBS) 
endif
...
#   install-certs
#
DEPS_145 += src/certs/samples/ca.crt
DEPS_145 += src/certs/samples/ca.key
DEPS_145 += src/certs/samples/dh.pem
DEPS_145 += src/certs/samples/ec.crt
DEPS_145 += src/certs/samples/ec.key
DEPS_145 += src/certs/samples/roots.crt
DEPS_145 += src/certs/samples/self.crt
DEPS_145 += src/certs/samples/self.key
DEPS_145 += src/certs/samples/test.crt
DEPS_145 += src/certs/samples/test.key
...
#   libsql
#
DEPS_146 += $(BUILD)/inc/sqlite3.h
DEPS_146 += $(BUILD)/obj/sqlite3.o

$(BUILD)/bin/libsql.so: $(DEPS_146)
...
#   libejs.db.sqlite
#
DEPS_147 += $(BUILD)/bin/libmpr.so
DEPS_147 += $(BUILD)/bin/libejs.so
DEPS_147 += $(BUILD)/bin/ejs.mod
DEPS_147 += $(BUILD)/bin/ejs.db.sqlite.mod
ifeq ($(ME_COM_SQLITE),1)
    DEPS_147 += $(BUILD)/bin/libsql.so
endif
DEPS_147 += $(BUILD)/obj/ejsSqlite.o
...
$(BUILD)/bin/libejs.db.sqlite.so: $(DEPS_147)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.so'
	$(CC) -shared -o $(BUILD)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_147) $(LIBS_147) $(LIBS_147) $(LIBS) 
...
DEPS_148 += $(BUILD)/inc/ejsWeb.h
DEPS_148 += $(BUILD)/obj/ejsHttpServer.o
DEPS_148 += $(BUILD)/obj/ejsRequest.o
DEPS_148 += $(BUILD)/obj/ejsSession.o
DEPS_148 += $(BUILD)/obj/ejsWeb.o
...
$(BUILD)/bin/libejs.web.so: $(DEPS_148)
	@echo '      [Link] $(BUILD)/bin/libejs.web.so'
	$(CC) -shared -o $(BUILD)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_148) $(LIBS_148) $(LIBS_148) $(LIBS) 

#
#   mvc.es
#
DEPS_149 += src/ejs.mvc/mvc.es

$(BUILD)/bin/mvc.es: $(DEPS_149)
...
DEPS_150 += $(BUILD)/bin/mvc.es
DEPS_150 += $(BUILD)/obj/ejsrun.o

ifeq ($(ME_COM_OPENSSL),1)
    LIBS_150 += -lmpr-openssl
    LIBPATHS_150 += -L"$(ME_COM_OPENSSL_PATH)"
endif
ifeq ($(ME_COM_OPENSSL),1)
ifeq ($(ME_COM_SSL),1)
    LIBS_150 += -lssl
...
$(BUILD)/bin/mvc: $(DEPS_150)
	@echo '      [Link] $(BUILD)/bin/mvc'
	$(CC) -o $(BUILD)/bin/mvc $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_150) $(LIBS_150) $(LIBS_150) $(LIBS) $(LIBS) 

#
#   utest.es
#
DEPS_151 += src/ejs.utest/utest.es

$(BUILD)/bin/utest.es: $(DEPS_151)
...
#   utest.worker
#
DEPS_152 += src/ejs.utest/utest.worker

$(BUILD)/bin/utest.worker: $(DEPS_152)
...
DEPS_153 += $(BUILD)/bin/utest.es
DEPS_153 += $(BUILD)/bin/utest.worker
DEPS_153 += $(BUILD)/obj/ejsrun.o
...
$(BUILD)/bin/utest: $(DEPS_153)
	@echo '      [Link] $(BUILD)/bin/utest'
	$(CC) -o $(BUILD)/bin/utest $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_153) $(LIBS_153) $(LIBS_153) $(LIBS) $(LIBS) 

#
#   watchdog
#
DEPS_154 += $(BUILD)/bin/libmpr.so
DEPS_154 += $(BUILD)/obj/watchdog.o
...
$(BUILD)/bin/ejsman: $(DEPS_154)
	@echo '      [Link] $(BUILD)/bin/ejsman'
	$(CC) -o $(BUILD)/bin/ejsman $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_154) $(LIBS_154) $(LIBS_154) $(LIBS) $(LIBS) 

#
#   www
#
DEPS_155 += src/ejs.web/www/images/banner.jpg
DEPS_155 += src/ejs.web/www/images/favicon.ico
DEPS_155 += src/ejs.web/www/images/splash.jpg
DEPS_155 += src/ejs.web/www/js/jquery.ejs.min.js
DEPS_155 += src/ejs.web/www/js/jquery.min.js
DEPS_155 += src/ejs.web/www/js/jquery.simplemodal.min.js
DEPS_155 += src/ejs.web/www/js/jquery.tablesorter.js
DEPS_155 += src/ejs.web/www/js/jquery.tablesorter.min.js
DEPS_155 += src/ejs.web/www/js/jquery.treeview.min.js
DEPS_155 += src/ejs.web/www/js/tree-images/file.gif
DEPS_155 += src/ejs.web/www/js/tree-images/folder-closed.gif
DEPS_155 += src/ejs.web/www/js/tree-images/folder.gif
DEPS_155 += src/ejs.web/www/js/tree-images/minus.gif
DEPS_155 += src/ejs.web/www/js/tree-images/plus.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-black-line.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-black.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-default-line.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-default.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-famfamfam-line.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-famfamfam.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-gray-line.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-gray.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-red-line.gif
DEPS_155 += src/ejs.web/www/js/tree-images/treeview-red.gif
DEPS_155 += src/ejs.web/www/js/treeview.css
DEPS_155 += src/ejs.web/www/layout.css
DEPS_155 += src/ejs.web/www/themes/default.css

$(BUILD)/bin/www: $(DEPS_155)
...
#   install
#
DEPS_160 += installPrep
DEPS_160 += stop
DEPS_160 += installBinary
DEPS_160 += start
