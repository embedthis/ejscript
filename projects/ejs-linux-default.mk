...
$(CONFIG)/bin/libmprssl.so: $(DEPS_13)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/mprSsl.o $(LIBPATHS_13) $(LIBS_13) $(LIBS_13) $(LIBS) 
...
$(CONFIG)/bin/ejsman: $(DEPS_15)
	...
	$(CC) -o $(CONFIG)/bin/ejsman $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBPATHS_15) $(LIBS_15) $(LIBS_15) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/makerom: $(DEPS_17)
	...
	$(CC) -o $(CONFIG)/bin/makerom $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBPATHS_17) $(LIBS_17) $(LIBS_17) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/libhttp.so: $(DEPS_24)
	@echo '      [Link] $(CONFIG)/bin/libhttp.so'
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/httpLib.o $(LIBPATHS_24) $(LIBS_24) $(LIBS_24) $(LIBS) 
...
$(CONFIG)/bin/http: $(DEPS_26)
	...
	$(CC) -o $(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/http.o $(LIBPATHS_26) $(LIBS_26) $(LIBS_26) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/libsqlite3.so: $(DEPS_29)
...
#   sqliteshell
#
DEPS_31 += $(CONFIG)/bin/libsqlite3.so
...
$(CONFIG)/bin/sqliteshell: $(DEPS_31)
	...
	$(CC) -o $(CONFIG)/bin/sqliteshell $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/sqlite.o $(LIBPATHS_31) $(LIBS_31) $(LIBS_31) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_106)
	...
	$(CC) -o $(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBPATHS_106) $(LIBS_106) $(LIBS_106) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/ejsc: $(DEPS_108)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBPATHS_108) $(LIBS_108) $(LIBS_108) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/ejsmod: $(DEPS_115)
	...
	$(CC) -o $(CONFIG)/bin/ejsmod $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsmod.o $(CONFIG)/obj/doc.o $(CONFIG)/obj/docFiles.o $(CONFIG)/obj/listing.o $(CONFIG)/obj/slotGen.o $(LIBPATHS_115) $(LIBS_115) $(LIBS_115) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/ejsrun: $(DEPS_117)
	...
	$(CC) -o $(CONFIG)/bin/ejsrun $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBPATHS_117) $(LIBS_117) $(LIBS_117) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/jem: $(DEPS_121)
	...
	$(CC) -o $(CONFIG)/bin/jem $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBPATHS_121) $(LIBS_121) $(LIBS_121) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
#   libejs.db.sqlite
#
DEPS_126 += $(CONFIG)/bin/libmpr.so
DEPS_126 += $(CONFIG)/bin/libejs.so
DEPS_126 += $(CONFIG)/bin/ejs.mod
DEPS_126 += $(CONFIG)/bin/ejs.db.sqlite.mod
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_126 += $(CONFIG)/bin/libsqlite3.so
endif
...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_126)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsSqlite.o $(LIBPATHS_126) $(LIBS_126) $(LIBS_126) $(LIBS) 
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_134)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsHttpServer.o $(CONFIG)/obj/ejsRequest.o $(CONFIG)/obj/ejsSession.o $(CONFIG)/obj/ejsWeb.o $(LIBPATHS_134) $(LIBS_134) $(LIBS_134) $(LIBS) 
...
ifeq ($(BIT_PACK_ZLIB),1)
    DEPS_139 += $(CONFIG)/bin/libzlib.so
endif
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_139)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsZlib.o $(LIBPATHS_139) $(LIBS_139) $(LIBS_139) $(LIBS) 
...
$(CONFIG)/bin/mvc: $(DEPS_142)
	...
	$(CC) -o $(CONFIG)/bin/mvc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/utest: $(DEPS_146)
	...
	$(CC) -o $(CONFIG)/bin/utest $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBPATHS_146) $(LIBS_146) $(LIBS_146) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
