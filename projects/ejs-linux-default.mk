...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_112)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsSqlite.o" $(LIBPATHS_112) $(LIBS_112) $(LIBS_112) $(LIBS) 
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_118)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_118) $(LIBS_118) $(LIBS_118) $(LIBS) 
...
$(CONFIG)/bin/libzlib.so: $(DEPS_121)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_123 += $(CONFIG)/bin/libzlib.so
endif
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_123)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_123) $(LIBS_123) $(LIBS_123) $(LIBS) 
...
DEPS_128 += $(CONFIG)/bin/libmpr.so
DEPS_128 += $(CONFIG)/inc/est.h
DEPS_128 += $(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_128 += $(CONFIG)/bin/libest.so
endif
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_128)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) 
