...
${CC} -dynamiclib -o ${CONFIG}\bin\libhttp.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/libhttp.dylib ${CONFIG}\obj\httpLib.o -lpcre -lmpr ${LIBS}
...
${CC} -dynamiclib -o ${CONFIG}\bin\ejs.zlib.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.zlib.dylib ${CONFIG}\obj\ejsZlib.o -lzlib -lejs ${LIBS} -lhttp -lpcre -lmpr
...
${CC} -dynamiclib -o ${CONFIG}\bin\ejs.db.sqlite.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.db.sqlite.dylib ${CONFIG}\obj\ejsSqlite.o -lsqlite3 -lejs -lmpr ${LIBS} -lhttp -lpcre
...
${CC} -dynamiclib -o ${CONFIG}\bin\ejs.web.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.web.dylib ${CONFIG}\obj\ejsHttpServer.o ${CONFIG}\obj\ejsRequest.o ${CONFIG}\obj\ejsSession.o ${CONFIG}\obj\ejsWeb.o -lejs ${LIBS} -lhttp -lpcre -lmpr
