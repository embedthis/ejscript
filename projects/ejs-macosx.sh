...
${CC} -dynamiclib -o ${CONFIG}\bin\libmprssl.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/libmprssl.dylib ${CONFIG}\obj\mprSsl.o ${LIBS} -lmpr
...
${CC} -dynamiclib -o ${CONFIG}\bin\libhttp.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/libhttp.dylib ${CONFIG}\obj\httpLib.o ${LIBS} -lmpr -lpcre
...
${CC} -c -o ${CONFIG}\obj\trees.o -arch x86_64 ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/trees.c
...
${CC} -o ${CONFIG}\bin\ejs -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejs.o ${LIBS} -lejs -lhttp -lmpr -lpcre -ledit

${CC} -c -o ${CONFIG}\obj\ejsc.o -arch x86_64 ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/cmd/ejsc.c

${CC} -o ${CONFIG}\bin\ejsc -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsc.o ${LIBS} -lejs -lhttp -lmpr -lpcre
...
${CC} -o ${CONFIG}\bin\ejsmod -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsmod.o ${CONFIG}\obj\doc.o ${CONFIG}\obj\docFiles.o ${CONFIG}\obj\listing.o ${CONFIG}\obj\slotGen.o ${LIBS} -lejs -lhttp -lmpr -lpcre

${CC} -c -o ${CONFIG}\obj\ejsrun.o -arch x86_64 ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/cmd/ejsrun.c

${CC} -o ${CONFIG}\bin\ejsrun -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsrun.o ${LIBS} -lejs -lhttp -lmpr -lpcre
...
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/utest.es
rm -rf ${CONFIG}/bin/utest
cp -r ${CONFIG}/bin/ejsrun ${CONFIG}/bin/utest

#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.unix.mod
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/jem.es
rm -rf ${CONFIG}/bin/jem
cp -r ${CONFIG}/bin/ejsrun ${CONFIG}/bin/jem

#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.db.mod
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.db.mapper.mod
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.db.sqlite.mod
${CC} -c -o ${CONFIG}\obj\ejsSqlite.o -arch x86_64 ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/jems/ejs.db.sqlite/ejsSqlite.c

${CC} -dynamiclib -o ${CONFIG}\bin\ejs.db.sqlite.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.db.sqlite.dylib ${CONFIG}\obj\ejsSqlite.o ${LIBS} -lmpr -lejs -lhttp -lpcre -lsqlite3
...
${CC} -dynamiclib -o ${CONFIG}\bin\ejs.web.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.web.dylib ${CONFIG}\obj\ejsHttpServer.o ${CONFIG}\obj\ejsRequest.o ${CONFIG}\obj\ejsSession.o ${CONFIG}\obj\ejsWeb.o ${LIBS} -lejs -lhttp -lmpr -lpcre
...
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.template.mod
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.tar.mod
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.zlib.mod
${CC} -dynamiclib -o ${CONFIG}\bin\ejs.zlib.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.zlib.dylib ${CONFIG}\obj\ejsZlib.o ${LIBS} -lmpr -lejs -lhttp -lpcre -lzlib

#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/mvc.es
rm -rf ${CONFIG}/bin/mvc
cp -r ${CONFIG}/bin/ejsrun ${CONFIG}/bin/mvc

#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/ejs.mvc.mod
#  Omit build script C:/cygwin/home/mob/ejs/macosx-x64-debug/bin/utest.worker
