...
${CC} -dynamiclib -o ${CONFIG}/bin/libhttp.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/libhttp.dylib ${CONFIG}/obj/httpLib.o ${LIBS} -lpam -lmpr -lpcre -lmprssl
...
${CC} -o ${CONFIG}/bin/ejs -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/ejs.o ${LIBS} -lejs -lhttp -lpam -lmpr -lpcre -lmprssl -ledit
...
${CC} -dynamiclib -o ${CONFIG}/bin/ejs.db.sqlite.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.db.sqlite.dylib ${CONFIG}/obj/ejsSqlite.o ${LIBS} -lmpr -lejs -lhttp -lpam -lpcre -lmprssl -lsqlite3
...
${CC} -dynamiclib -o ${CONFIG}/bin/ejs.web.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 2.0.1 -current_version 2.0.1 ${LIBPATHS} -install_name @rpath/ejs.web.dylib ${CONFIG}/obj/ejsHttpServer.o ${CONFIG}/obj/ejsRequest.o ${CONFIG}/obj/ejsSession.o ${CONFIG}/obj/ejsWeb.o ${LIBS} -lejs -lhttp -lpam -lmpr -lpcre -lmprssl
