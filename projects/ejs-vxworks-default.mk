...
$(CONFIG)/bin/makerom.out: $(DEPS_10)
	@echo '      [Link] makerom'
...
$(CONFIG)/bin/libpcre.out: $(DEPS_17)
	@echo '      [Link] libpcre'
...
$(CONFIG)/bin/libhttp.out: $(DEPS_20)
	@echo '      [Link] libhttp'
...
#   http
#
DEPS_22 += $(CONFIG)/bin/libhttp.out
...
$(CONFIG)/bin/libsqlite3.out: $(DEPS_25)
...
#
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_27 += $(CONFIG)/bin/libsqlite3.out
endif
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_122 += $(CONFIG)/bin/libsqlite3.out
endif
