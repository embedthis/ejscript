...
$(CONFIG)/bin/libsql.out: $(DEPS_111)
...
ifeq ($(ME_COM_SQLITE),1)
    DEPS_113 += $(CONFIG)/bin/libsql.out
endif
DEPS_113 += $(CONFIG)/obj/ejsSqlite.o

$(CONFIG)/bin/libejs.db.sqlite.out: $(DEPS_113)
...
$(CONFIG)/bin/libejs.web.out: $(DEPS_119)
...
$(CONFIG)/bin/libzlib.out: $(DEPS_122)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_124 += $(CONFIG)/bin/libzlib.out
endif
DEPS_124 += $(CONFIG)/obj/ejsZlib.o

$(CONFIG)/bin/libejs.zlib.out: $(DEPS_124)
...
$(CONFIG)/bin/libest.out: $(DEPS_127)
...
ifeq ($(ME_COM_EST),1)
    DEPS_129 += $(CONFIG)/bin/libest.out
endif
...
$(CONFIG)/bin/libmprssl.out: $(DEPS_129)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.out'
	$(CC) -r -o $(CONFIG)/bin/libmprssl.out $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_129) $(LIBS_129) $(LIBS_129) $(LIBS) 
...
$(CONFIG)/bin/ejsman.out: $(DEPS_131)
...
DEPS_135 += $(CONFIG)/bin/libsql.out
DEPS_135 += $(CONFIG)/obj/sqlite.o

$(CONFIG)/bin/sqlite.out: $(DEPS_135)
