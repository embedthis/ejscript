...
DFLAGS            += -D_REENTRANT -DVXWORKS -DRW_MULTI_THREAD -D_GNU_TOOL -DCPU=PENTIUM $(patsubst %,-D%,$(filter BIT_%,$(MAKEFLAGS))) -DBIT_PACK_EST=$(BIT_PACK_EST) -DBIT_PACK_SSL=$(BIT_PACK_SSL) -DBIT_PACK_SQLITE=$(BIT_PACK_SQLITE) 
...
$(CONFIG)/bin/libzlib.out: $(DEPS_31)
	@echo '      [Link] libzlib'
...
$(CONFIG)/bin/libejs.out: $(DEPS_101)
	@echo '      [Link] libejs'
...
$(CONFIG)/bin/ejsmod.out: $(DEPS_112)
	@echo '      [Link] ejsmod'
...
$(CONFIG)/bin/ejsrun.out: $(DEPS_114)
	@echo '      [Link] ejsrun'
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_123 += $(CONFIG)/bin/libsqlite3.out
endif
...
$(CONFIG)/bin/libejs.db.sqlite.out: $(DEPS_123)
...
DEPS_125 += $(CONFIG)/bin/ejsmod.out
...
$(CONFIG)/bin/libejs.web.out: $(DEPS_131)
...
DEPS_136 += $(CONFIG)/bin/libzlib.out
...
$(CONFIG)/bin/libejs.zlib.out: $(DEPS_136)
...
#   utest
#
DEPS_143 += $(CONFIG)/bin/libejs.out
