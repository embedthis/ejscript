...
$(CONFIG)/bin/jem.out: $(DEPS_119)
	...
	$(CC) -o $(CONFIG)/bin/jem.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBS) -Wl,-r 
...
DEPS_141 += $(CONFIG)/bin/libejs.out
