...
$(CONFIG)/bin/libmprssl.out: $(DEPS_13)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.out'
	$(CC) -r -o $(CONFIG)/bin/libmprssl.out $(LDFLAGS) $(LIBPATHS)    $(CONFIG)/obj/mprSsl.o $(LIBPATHS_13) $(LIBS_13) $(LIBS_13) $(LIBS) 
...
$(CONFIG)/bin/libpcre.out: $(DEPS_21)
...
$(CONFIG)/bin/libhttp.out: $(DEPS_24)
...
$(CONFIG)/bin/libsqlite3.out: $(DEPS_29)
...
#   sqliteshell
#
DEPS_31 += $(CONFIG)/bin/libsqlite3.out
DEPS_31 += $(CONFIG)/obj/sqlite.o

$(CONFIG)/bin/sqliteshell.out: $(DEPS_31)
...
$(CONFIG)/bin/libejs.out: $(DEPS_104)
...
#   ejsc
#
DEPS_108 += $(CONFIG)/bin/libejs.out
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_126 += $(CONFIG)/bin/libsqlite3.out
endif
DEPS_126 += $(CONFIG)/obj/ejsSqlite.o

$(CONFIG)/bin/libejs.db.sqlite.out: $(DEPS_126)
...
$(CONFIG)/bin/libejs.web.out: $(DEPS_134)
...
ifeq ($(BIT_PACK_ZLIB),1)
    DEPS_139 += $(CONFIG)/bin/libzlib.out
endif
DEPS_139 += $(CONFIG)/obj/ejsZlib.o

$(CONFIG)/bin/libejs.zlib.out: $(DEPS_139)
...
#   utest
#
DEPS_146 += $(CONFIG)/bin/libejs.out
