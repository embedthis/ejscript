...
$(BUILD)/bin/libmpr.out: $(DEPS_122)
	@echo '      [Link] $(BUILD)/bin/libmpr.out'
	$(CC) -r -o $(BUILD)/bin/libmpr.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprLib.o" $(LIBPATHS_122) $(LIBS_122) $(LIBS_122) $(LIBS) 
...
$(BUILD)/bin/libpcre.out: $(DEPS_123)
...
#   libhttp
#
DEPS_124 += $(BUILD)/bin/libmpr.out
ifeq ($(ME_COM_PCRE),1)
    DEPS_124 += $(BUILD)/bin/libpcre.out
endif
...
$(BUILD)/bin/libhttp.out: $(DEPS_124)
	@echo '      [Link] $(BUILD)/bin/libhttp.out'
	$(CC) -r -o $(BUILD)/bin/libhttp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/httpLib.o" $(LIBPATHS_124) $(LIBS_124) $(LIBS_124) $(LIBS) 
endif
...
DEPS_125 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_125 += $(BUILD)/bin/libhttp.out
endif
...
$(BUILD)/bin/ejs.out: $(DEPS_126)
	@echo '      [Link] $(BUILD)/bin/ejs.out'
	$(CC) -o $(BUILD)/bin/ejs.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejs.o" $(LIBPATHS_126) $(LIBS_126) $(LIBS_126) $(LIBS) -Wl,-r 

#
#   ejsc
#
DEPS_127 += $(BUILD)/bin/libejs.out
...
$(BUILD)/bin/ejsc.out: $(DEPS_127)
	@echo '      [Link] $(BUILD)/bin/ejsc.out'
	$(CC) -o $(BUILD)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsc.o" $(LIBPATHS_127) $(LIBS_127) $(LIBS_127) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/ejsmod.out: $(DEPS_128)
	@echo '      [Link] $(BUILD)/bin/ejsmod.out'
	$(CC) -o $(BUILD)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/libzlib.out: $(DEPS_138)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_139 += $(BUILD)/bin/libzlib.out
endif
...
$(BUILD)/bin/libejs.zlib.out: $(DEPS_139)
	@echo '      [Link] $(BUILD)/bin/libejs.zlib.out'
	$(CC) -r -o $(BUILD)/bin/libejs.zlib.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsZlib.o" $(LIBPATHS_139) $(LIBS_139) $(LIBS_139) $(LIBS) 
...
DEPS_140 += $(BUILD)/bin/libejs.zlib.out
...
DEPS_141 += $(BUILD)/bin/libejs.zlib.out
...
$(BUILD)/bin/ejsrun.out: $(DEPS_142)
	@echo '      [Link] $(BUILD)/bin/ejsrun.out'
	$(CC) -o $(BUILD)/bin/ejsrun.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) -Wl,-r 

ifeq ($(ME_COM_HTTP),1)
#
#   httpcmd
#
DEPS_143 += $(BUILD)/bin/libhttp.out
...
$(BUILD)/bin/http.out: $(DEPS_143)
	@echo '      [Link] $(BUILD)/bin/http.out'
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/http.o" $(LIBPATHS_143) $(LIBS_143) $(LIBS_143) $(LIBS) -Wl,-r 
endif
...
$(BUILD)/bin/libejs.db.sqlite.out: $(DEPS_146)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.out'
	$(CC) -r -o $(BUILD)/bin/libejs.db.sqlite.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_146) $(LIBS_146) $(LIBS_146) $(LIBS) 

#
#   libejs.web
#
DEPS_147 += $(BUILD)/bin/libejs.out
...
$(BUILD)/bin/libejs.web.out: $(DEPS_147)
	@echo '      [Link] $(BUILD)/bin/libejs.web.out'
	$(CC) -r -o $(BUILD)/bin/libejs.web.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_147) $(LIBS_147) $(LIBS_147) $(LIBS) 
...
$(BUILD)/bin/mvc.out: $(DEPS_149)
	@echo '      [Link] $(BUILD)/bin/mvc.out'
	$(CC) -o $(BUILD)/bin/mvc.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_149) $(LIBS_149) $(LIBS_149) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/utest.out: $(DEPS_152)
	@echo '      [Link] $(BUILD)/bin/utest.out'
	$(CC) -o $(BUILD)/bin/utest.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_152) $(LIBS_152) $(LIBS_152) $(LIBS) -Wl,-r 

#
#   watchdog
#
DEPS_153 += $(BUILD)/bin/libmpr.out
...
$(BUILD)/bin/ejsman.out: $(DEPS_153)
	@echo '      [Link] $(BUILD)/bin/ejsman.out'
	$(CC) -o $(BUILD)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_153) $(LIBS_153) $(LIBS_153) $(LIBS) -Wl,-r 
