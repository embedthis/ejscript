...
DFLAGS             += -DVXWORKS -DRW_MULTI_THREAD -D_GNU_TOOL -DCPU=PENTIUM $(patsubst %,-D%,$(filter ME_%,$(MAKEFLAGS))) -DME_EXT_EST=$(ME_EXT_EST) -DME_EXT_MATRIXSSL=$(ME_EXT_MATRIXSSL) -DME_EXT_NANOSSL=$(ME_EXT_NANOSSL) -DME_EXT_OPENSSL=$(ME_EXT_OPENSSL) -DME_EXT_PCRE=$(ME_EXT_PCRE) -DME_EXT_SQLITE=$(ME_EXT_SQLITE) -DME_EXT_SSL=$(ME_EXT_SSL) -DME_EXT_ZLIB=$(ME_EXT_ZLIB) 
...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/ejs-vxworks-default-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/ejs-vxworks-default-me.h >/dev/null ; then\
		cp projects/ejs-vxworks-default-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
...
DEPS_18 += $(CONFIG)/bin/libmpr.out
DEPS_18 += $(CONFIG)/inc/pcre.h
DEPS_18 += $(CONFIG)/obj/pcre.o
ifeq ($(ME_EXT_PCRE),1)
    DEPS_18 += $(CONFIG)/bin/libpcre.out
endif
...
$(CONFIG)/bin/httpcmd.out: $(DEPS_18)
...
ifeq ($(ME_EXT_EST),1)
    DEPS_20 += $(CONFIG)/bin/libest.out
endif
DEPS_20 += $(CONFIG)/obj/mprSsl.o

$(CONFIG)/bin/libmprssl.out: $(DEPS_20)
...
$(CONFIG)/bin/ejsman.out: $(DEPS_22)
	@echo '      [Link] $(CONFIG)/bin/ejsman.out'
	 -o $(CONFIG)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBS) -Wl,-r 
...
$(CONFIG)/obj/sqlite3.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/sqlite3.o'
	 -c -o $(CONFIG)/obj/sqlite3.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/paks/sqlite/sqlite3.c
...
$(CONFIG)/bin/libsql.out: $(DEPS_25)
	@echo '      [Link] $(CONFIG)/bin/libsql.out'
	 -r -o $(CONFIG)/bin/libsql.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite3.o" $(LIBS) 
endif
...
$(CONFIG)/obj/sqlite.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/sqlite.o'
	 -c -o $(CONFIG)/obj/sqlite.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/paks/sqlite/sqlite.c
...
DEPS_27 += $(CONFIG)/bin/libsql.out
DEPS_27 += $(CONFIG)/obj/sqlite.o

$(CONFIG)/bin/sqlite.out: $(DEPS_27)
	@echo '      [Link] $(CONFIG)/bin/sqlite.out'
	 -o $(CONFIG)/bin/sqlite.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBS) -Wl,-r 
endif
...
$(CONFIG)/bin/libzlib.out: $(DEPS_30)
...
$(CONFIG)/obj/ecAst.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecAst.o'
	 -c -o $(CONFIG)/obj/ecAst.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecAst.c
...
$(CONFIG)/obj/ecCodeGen.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecCodeGen.o'
	 -c -o $(CONFIG)/obj/ecCodeGen.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecCodeGen.c
...
$(CONFIG)/obj/ecCompiler.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecCompiler.o'
	 -c -o $(CONFIG)/obj/ecCompiler.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecCompiler.c
...
$(CONFIG)/obj/ecLex.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecLex.o'
	 -c -o $(CONFIG)/obj/ecLex.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecLex.c
...
$(CONFIG)/obj/ecModuleWrite.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecModuleWrite.o'
	 -c -o $(CONFIG)/obj/ecModuleWrite.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecModuleWrite.c
...
$(CONFIG)/obj/ecParser.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecParser.o'
	 -c -o $(CONFIG)/obj/ecParser.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecParser.c
...
$(CONFIG)/obj/ecState.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ecState.o'
	 -c -o $(CONFIG)/obj/ecState.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/compiler/ecState.c
...
$(CONFIG)/obj/dtoa.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/dtoa.o'
	 -c -o $(CONFIG)/obj/dtoa.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/dtoa.c
...
$(CONFIG)/obj/ejsApp.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsApp.o'
	 -c -o $(CONFIG)/obj/ejsApp.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsApp.c
...
$(CONFIG)/obj/ejsArray.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsArray.o'
	 -c -o $(CONFIG)/obj/ejsArray.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsArray.c
...
$(CONFIG)/obj/ejsBlock.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsBlock.o'
	 -c -o $(CONFIG)/obj/ejsBlock.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsBlock.c
...
$(CONFIG)/obj/ejsBoolean.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsBoolean.o'
	 -c -o $(CONFIG)/obj/ejsBoolean.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsBoolean.c
...
$(CONFIG)/obj/ejsByteArray.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsByteArray.o'
	 -c -o $(CONFIG)/obj/ejsByteArray.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsByteArray.c
...
$(CONFIG)/obj/ejsCache.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsCache.o'
	 -c -o $(CONFIG)/obj/ejsCache.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsCache.c
...
$(CONFIG)/obj/ejsCmd.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsCmd.o'
	 -c -o $(CONFIG)/obj/ejsCmd.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsCmd.c
...
$(CONFIG)/obj/ejsConfig.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsConfig.o'
	 -c -o $(CONFIG)/obj/ejsConfig.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsConfig.c
...
$(CONFIG)/obj/ejsDate.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsDate.o'
	 -c -o $(CONFIG)/obj/ejsDate.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsDate.c
...
$(CONFIG)/obj/ejsDebug.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsDebug.o'
	 -c -o $(CONFIG)/obj/ejsDebug.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsDebug.c
...
$(CONFIG)/obj/ejsError.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsError.o'
	 -c -o $(CONFIG)/obj/ejsError.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsError.c
...
$(CONFIG)/obj/ejsFile.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsFile.o'
	 -c -o $(CONFIG)/obj/ejsFile.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsFile.c
...
$(CONFIG)/obj/ejsFileSystem.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsFileSystem.o'
	 -c -o $(CONFIG)/obj/ejsFileSystem.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsFileSystem.c
...
$(CONFIG)/obj/ejsFrame.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsFrame.o'
	 -c -o $(CONFIG)/obj/ejsFrame.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsFrame.c
...
$(CONFIG)/obj/ejsFunction.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsFunction.o'
	 -c -o $(CONFIG)/obj/ejsFunction.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsFunction.c
...
$(CONFIG)/obj/ejsGC.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsGC.o'
	 -c -o $(CONFIG)/obj/ejsGC.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsGC.c
...
$(CONFIG)/obj/ejsGlobal.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsGlobal.o'
	 -c -o $(CONFIG)/obj/ejsGlobal.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsGlobal.c
...
$(CONFIG)/obj/ejsHttp.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsHttp.o'
	 -c -o $(CONFIG)/obj/ejsHttp.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsHttp.c
...
$(CONFIG)/obj/ejsIterator.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsIterator.o'
	 -c -o $(CONFIG)/obj/ejsIterator.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsIterator.c
...
$(CONFIG)/obj/ejsJSON.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsJSON.o'
	 -c -o $(CONFIG)/obj/ejsJSON.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsJSON.c
...
$(CONFIG)/obj/ejsLocalCache.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsLocalCache.o'
	 -c -o $(CONFIG)/obj/ejsLocalCache.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsLocalCache.c
...
$(CONFIG)/obj/ejsMath.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsMath.o'
	 -c -o $(CONFIG)/obj/ejsMath.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsMath.c
...
$(CONFIG)/obj/ejsMemory.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsMemory.o'
	 -c -o $(CONFIG)/obj/ejsMemory.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsMemory.c
...
$(CONFIG)/obj/ejsMprLog.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsMprLog.o'
	 -c -o $(CONFIG)/obj/ejsMprLog.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsMprLog.c
...
$(CONFIG)/obj/ejsNamespace.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsNamespace.o'
	 -c -o $(CONFIG)/obj/ejsNamespace.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsNamespace.c
...
$(CONFIG)/obj/ejsNull.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsNull.o'
	 -c -o $(CONFIG)/obj/ejsNull.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsNull.c
...
$(CONFIG)/obj/ejsNumber.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsNumber.o'
	 -c -o $(CONFIG)/obj/ejsNumber.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsNumber.c
...
$(CONFIG)/obj/ejsObject.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsObject.o'
	 -c -o $(CONFIG)/obj/ejsObject.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsObject.c
...
$(CONFIG)/obj/ejsPath.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsPath.o'
	 -c -o $(CONFIG)/obj/ejsPath.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsPath.c
...
$(CONFIG)/obj/ejsPot.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsPot.o'
	 -c -o $(CONFIG)/obj/ejsPot.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsPot.c
...
$(CONFIG)/obj/ejsRegExp.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsRegExp.o'
	 -c -o $(CONFIG)/obj/ejsRegExp.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsRegExp.c
...
$(CONFIG)/obj/ejsSocket.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsSocket.o'
	 -c -o $(CONFIG)/obj/ejsSocket.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsSocket.c
...
$(CONFIG)/obj/ejsString.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsString.o'
	 -c -o $(CONFIG)/obj/ejsString.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsString.c
...
$(CONFIG)/obj/ejsSystem.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsSystem.o'
	 -c -o $(CONFIG)/obj/ejsSystem.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsSystem.c
...
$(CONFIG)/obj/ejsTimer.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsTimer.o'
	 -c -o $(CONFIG)/obj/ejsTimer.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsTimer.c
...
$(CONFIG)/obj/ejsType.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsType.o'
	 -c -o $(CONFIG)/obj/ejsType.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsType.c
...
$(CONFIG)/obj/ejsUri.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsUri.o'
	 -c -o $(CONFIG)/obj/ejsUri.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsUri.c
...
$(CONFIG)/obj/ejsVoid.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsVoid.o'
	 -c -o $(CONFIG)/obj/ejsVoid.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsVoid.c
...
$(CONFIG)/obj/ejsWebSocket.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsWebSocket.o'
	 -c -o $(CONFIG)/obj/ejsWebSocket.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsWebSocket.c
...
$(CONFIG)/obj/ejsWorker.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsWorker.o'
	 -c -o $(CONFIG)/obj/ejsWorker.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsWorker.c
...
$(CONFIG)/obj/ejsXML.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsXML.o'
	 -c -o $(CONFIG)/obj/ejsXML.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsXML.c
...
$(CONFIG)/obj/ejsXMLList.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsXMLList.o'
	 -c -o $(CONFIG)/obj/ejsXMLList.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsXMLList.c
...
$(CONFIG)/obj/ejsXMLLoader.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsXMLLoader.o'
	 -c -o $(CONFIG)/obj/ejsXMLLoader.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/core/src/ejsXMLLoader.c
...
$(CONFIG)/obj/ejsByteCode.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsByteCode.o'
	 -c -o $(CONFIG)/obj/ejsByteCode.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsByteCode.c
...
$(CONFIG)/obj/ejsException.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsException.o'
	 -c -o $(CONFIG)/obj/ejsException.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsException.c
...
$(CONFIG)/obj/ejsHelper.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsHelper.o'
	 -c -o $(CONFIG)/obj/ejsHelper.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsHelper.c
...
$(CONFIG)/obj/ejsInterp.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsInterp.o'
	 -c -o $(CONFIG)/obj/ejsInterp.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsInterp.c
...
$(CONFIG)/obj/ejsLoader.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsLoader.o'
	 -c -o $(CONFIG)/obj/ejsLoader.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsLoader.c
...
$(CONFIG)/obj/ejsModule.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsModule.o'
	 -c -o $(CONFIG)/obj/ejsModule.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsModule.c
...
$(CONFIG)/obj/ejsScope.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsScope.o'
	 -c -o $(CONFIG)/obj/ejsScope.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsScope.c
...
$(CONFIG)/obj/ejsService.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsService.o'
	 -c -o $(CONFIG)/obj/ejsService.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/vm/ejsService.c
...
$(CONFIG)/obj/ejs.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejs.o'
	 -c -o $(CONFIG)/obj/ejs.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/cmd/ejs.c
...
DEPS_102 += $(CONFIG)/bin/libejs.out
DEPS_102 += $(CONFIG)/obj/ejs.o

$(CONFIG)/bin/ejs.out: $(DEPS_102)
	@echo '      [Link] $(CONFIG)/bin/ejs.out'
	 -o $(CONFIG)/bin/ejs.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBS) -Wl,-r 
...
$(CONFIG)/obj/ejsc.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsc.o'
	 -c -o $(CONFIG)/obj/ejsc.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/cmd/ejsc.c
...
$(CONFIG)/bin/ejsc.out: $(DEPS_104)
	@echo '      [Link] $(CONFIG)/bin/ejsc.out'
	 -o $(CONFIG)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBS) -Wl,-r 
...
$(CONFIG)/obj/ejsmod.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsmod.o'
	 -c -o $(CONFIG)/obj/ejsmod.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/cmd/ejsmod.c
...
$(CONFIG)/obj/doc.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/doc.o'
	 -c -o $(CONFIG)/obj/doc.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/cmd/doc.c
...
$(CONFIG)/obj/docFiles.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/docFiles.o'
	 -c -o $(CONFIG)/obj/docFiles.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/cmd/docFiles.c
...
$(CONFIG)/obj/listing.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/listing.o'
	 -c -o $(CONFIG)/obj/listing.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/cmd/listing.c
...
$(CONFIG)/obj/slotGen.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/slotGen.o'
	 -c -o $(CONFIG)/obj/slotGen.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/cmd/slotGen.c
...
DEPS_111 += $(CONFIG)/bin/libejs.out
...
$(CONFIG)/bin/ejsmod.out: $(DEPS_111)
	@echo '      [Link] $(CONFIG)/bin/ejsmod.out'
	 -o $(CONFIG)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsmod.o" "$(CONFIG)/obj/doc.o" "$(CONFIG)/obj/docFiles.o" "$(CONFIG)/obj/listing.o" "$(CONFIG)/obj/slotGen.o" $(LIBS) -Wl,-r 
...
$(CONFIG)/obj/ejsrun.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsrun.o'
	 -c -o $(CONFIG)/obj/ejsrun.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" src/cmd/ejsrun.c
...
$(CONFIG)/bin/ejsrun.out: $(DEPS_113)
	@echo '      [Link] $(CONFIG)/bin/ejsrun.out'
	 -o $(CONFIG)/bin/ejsrun.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBS) -Wl,-r 
...
DEPS_114 += $(CONFIG)/bin/libejs.out
...
DEPS_114 += $(CONFIG)/bin/ejsmod.out
...
DEPS_115 += $(CONFIG)/bin/ejsmod.out
...
$(CONFIG)/obj/ejsSqlite.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsSqlite.o'
	 -c -o $(CONFIG)/obj/ejsSqlite.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/ejs.db.sqlite/ejsSqlite.c
...
ifeq ($(ME_EXT_SQLITE),1)
    DEPS_120 += $(CONFIG)/bin/libsql.out
endif
DEPS_120 += $(CONFIG)/obj/ejsSqlite.o

$(CONFIG)/bin/libejs.db.sqlite.out: $(DEPS_120)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.out'
	 -r -o $(CONFIG)/bin/libejs.db.sqlite.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsSqlite.o" $(LIBS) 
...
ifeq ($(ME_EXT_PCRE),1)
    DEPS_121 += $(CONFIG)/bin/libpcre.out
endif
DEPS_121 += $(CONFIG)/inc/http.h
DEPS_121 += $(CONFIG)/obj/httpLib.o
DEPS_121 += $(CONFIG)/bin/libhttp.out
...
$(CONFIG)/obj/ejsHttpServer.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsHttpServer.o'
	 -c -o $(CONFIG)/obj/ejsHttpServer.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/ejs.web/ejsHttpServer.c
...
$(CONFIG)/obj/ejsRequest.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsRequest.o'
	 -c -o $(CONFIG)/obj/ejsRequest.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/ejs.web/ejsRequest.c
...
$(CONFIG)/obj/ejsSession.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsSession.o'
	 -c -o $(CONFIG)/obj/ejsSession.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/ejs.web/ejsSession.c
...
$(CONFIG)/obj/ejsWeb.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsWeb.o'
	 -c -o $(CONFIG)/obj/ejsWeb.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/ejs.web/ejsWeb.c
...
$(CONFIG)/bin/libejs.web.out: $(DEPS_128)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.out'
	 -r -o $(CONFIG)/bin/libejs.web.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBS) 
...
DEPS_131 += $(CONFIG)/bin/ejsmod.out
...
$(CONFIG)/obj/ejsZlib.o: \
	...
	@echo '   [Compile] $(CONFIG)/obj/ejsZlib.o'
	 -c -o $(CONFIG)/obj/ejsZlib.o $(CFLAGS) $(DFLAGS) "-I$(CONFIG)/inc" "-I$(WIND_BASE)/target/h" "-I$(WIND_BASE)/target/h/wrn/coreip" "-Isrc/cmd" src/ejs.zlib/ejsZlib.c
...
$(CONFIG)/bin/libejs.zlib.out: $(DEPS_133)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.out'
	 -r -o $(CONFIG)/bin/libejs.zlib.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsZlib.o" $(LIBS) 
...
DEPS_134 += $(CONFIG)/bin/ejsmod.out
...
$(CONFIG)/bin/mvc.out: $(DEPS_136)
	@echo '      [Link] $(CONFIG)/bin/mvc.out'
	 -o $(CONFIG)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBS) -Wl,-r 
...
DEPS_137 += $(CONFIG)/bin/ejsmod.out
...
$(CONFIG)/bin/utest.out: $(DEPS_140)
	@echo '      [Link] $(CONFIG)/bin/utest.out'
	 -o $(CONFIG)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBS) -Wl,-r 
