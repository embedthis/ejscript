...
build/$(CONFIG)/bin/ejsmod.out: $(DEPS_93)
	...
	$(CC) -o build/$(CONFIG)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/doc.o" "build/$(CONFIG)/obj/docFiles.o" "build/$(CONFIG)/obj/ejsmod.o" "build/$(CONFIG)/obj/listing.o" "build/$(CONFIG)/obj/slotGen.o" $(LIBS) -Wl,-r 
