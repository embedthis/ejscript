...
$(CONFIG)/bin/libhttp.so: $(DEPS_16)
	...
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LIBPATHS) "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_16) $(LIBS_16) $(LIBS_16) $(LIBS) 
...
$(CONFIG)/bin/httpcmd: $(DEPS_18)
	...
	$(CC) -o $(CONFIG)/bin/httpcmd $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_18) $(LIBS_18) $(LIBS_18) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_20)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS) "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_20) $(LIBS_20) $(LIBS_20) $(LIBS) 
...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_120)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LIBPATHS) "$(CONFIG)/obj/ejsSqlite.o" $(LIBPATHS_120) $(LIBS_120) $(LIBS_120) $(LIBS) 
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_128)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LIBPATHS) "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) 
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_133)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LIBPATHS) "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_133) $(LIBS_133) $(LIBS_133) $(LIBS) 
