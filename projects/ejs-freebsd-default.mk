...
CFLAGS            += -fPIC  -w
DFLAGS            += -D_REENTRANT -DPIC  $(patsubst %,-D%,$(filter BIT_%,$(MAKEFLAGS))) -DBIT_PACK_EST=$(BIT_PACK_EST) -DBIT_PACK_SSL=$(BIT_PACK_SSL) -DBIT_PACK_SQLITE=$(BIT_PACK_SQLITE) 
IFLAGS            += -I$(CONFIG)/inc
LDFLAGS           += '-g'
...
$(CONFIG)/bin/ejsman: $(DEPS_12)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/ejsman $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_12) $(LIBS_12) $(LIBS) $(LDFLAGS)
...
$(CONFIG)/bin/ejs: $(DEPS_103)
	@echo '      [Link] ejs'
	$(CC) -o $(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS_103) $(LIBS_103) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/ejsc: $(DEPS_105)
	@echo '      [Link] ejsc'
	$(CC) -o $(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBS_105) $(LIBS_105) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/ejsmod: $(DEPS_112)
	@echo '      [Link] ejsmod'
	$(CC) -o $(CONFIG)/bin/ejsmod $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsmod.o $(CONFIG)/obj/doc.o $(CONFIG)/obj/docFiles.o $(CONFIG)/obj/listing.o $(CONFIG)/obj/slotGen.o $(LIBS_112) $(LIBS_112) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/ejsrun: $(DEPS_114)
	@echo '      [Link] ejsrun'
	$(CC) -o $(CONFIG)/bin/ejsrun $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_114) $(LIBS_114) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/jem: $(DEPS_118)
	@echo '      [Link] jem'
	$(CC) -o $(CONFIG)/bin/jem $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_118) $(LIBS_118) $(LIBS) -lmpr $(LDFLAGS)
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_123 += $(CONFIG)/bin/libsqlite3.so
endif
...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_123)
	@echo '      [Link] libejs.db.sqlite'
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsSqlite.o $(LIBS_123) $(LIBS_123) $(LIBS) -lpcre
...
$(CONFIG)/bin/ejs.mail.mod: $(DEPS_124)
...
$(CONFIG)/bin/ejs.web.mod: $(DEPS_125)
...
$(CONFIG)/obj/ejsHttpServer.o: \
    src/jems/ejs.web/ejsHttpServer.c $(DEPS_127)
...
$(CONFIG)/obj/ejsRequest.o: \
    src/jems/ejs.web/ejsRequest.c $(DEPS_128)
...
$(CONFIG)/obj/ejsSession.o: \
    src/jems/ejs.web/ejsSession.c $(DEPS_129)
...
$(CONFIG)/obj/ejsWeb.o: \
    src/jems/ejs.web/ejsWeb.c $(DEPS_130)
...
DEPS_131 += $(CONFIG)/obj/ejsHttpServer.o
DEPS_131 += $(CONFIG)/obj/ejsRequest.o
DEPS_131 += $(CONFIG)/obj/ejsSession.o
DEPS_131 += $(CONFIG)/obj/ejsWeb.o
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_131)
	@echo '      [Link] libejs.web'
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsHttpServer.o $(CONFIG)/obj/ejsRequest.o $(CONFIG)/obj/ejsSession.o $(CONFIG)/obj/ejsWeb.o $(LIBS_131) $(LIBS_131) $(LIBS) -lmpr

#
#   www
#
$(CONFIG)/bin/www: $(DEPS_132)
...
$(CONFIG)/bin/ejs.template.mod: $(DEPS_133)
...
$(CONFIG)/bin/ejs.zlib.mod: $(DEPS_134)
...
$(CONFIG)/obj/ejsZlib.o: \
    src/jems/ejs.zlib/ejsZlib.c $(DEPS_135)
...
DEPS_136 += $(CONFIG)/bin/ejs.zlib.mod
DEPS_136 += $(CONFIG)/bin/libzlib.so
DEPS_136 += $(CONFIG)/obj/ejsZlib.o
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_136)
	@echo '      [Link] libejs.zlib'
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsZlib.o $(LIBS_136) $(LIBS_136) $(LIBS) -lmpr
...
DEPS_139 += $(CONFIG)/bin/mvc.es
DEPS_139 += $(CONFIG)/obj/ejsrun.o
...
$(CONFIG)/bin/mvc: $(DEPS_139)
	@echo '      [Link] mvc'
	$(CC) -o $(CONFIG)/bin/mvc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_139) $(LIBS_139) $(LIBS) -lmpr $(LDFLAGS)
...
DEPS_140 += $(CONFIG)/bin/ejs.web.mod
DEPS_140 += $(CONFIG)/bin/ejs.template.mod
DEPS_140 += $(CONFIG)/bin/ejs.unix.mod

$(CONFIG)/bin/ejs.mvc.mod: $(DEPS_140)
	cd src/jems/ejs.mvc; ../../../$(CONFIG)/bin/ejsc --out ../../../$(CONFIG)/bin/ejs.mvc.mod  --optimize 9 *.es ; cd ../../..

#
#   utest.es
#
$(CONFIG)/bin/utest.es: $(DEPS_141)
	cd src/jems/ejs.utest; cp utest.es ../../../$(CONFIG)/bin ; cd ../../..

#
#   utest.worker
#
$(CONFIG)/bin/utest.worker: $(DEPS_142)
	cd src/jems/ejs.utest; cp utest.worker ../../../$(CONFIG)/bin ; cd ../../..

#
#   utest
#
DEPS_143 += $(CONFIG)/bin/libejs.so
DEPS_143 += $(CONFIG)/bin/utest.es
DEPS_143 += $(CONFIG)/bin/utest.worker
DEPS_143 += $(CONFIG)/obj/ejsrun.o
...
$(CONFIG)/bin/utest: $(DEPS_143)
	@echo '      [Link] utest'
	$(CC) -o $(CONFIG)/bin/utest $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_143) $(LIBS_143) $(LIBS) -lmpr $(LDFLAGS)
