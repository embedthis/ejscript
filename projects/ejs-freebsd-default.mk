...
$(CONFIG)/bin/ejsman: $(DEPS_7)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/ejsman $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_7) $(LIBS_7) $(LIBS) $(LDFLAGS)
...
$(CONFIG)/bin/makerom: $(DEPS_9)
	@echo '      [Link] makerom'
	$(CC) -o $(CONFIG)/bin/makerom $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBS_9) $(LIBS_9) $(LIBS) $(LDFLAGS)
...
$(CONFIG)/bin/libhttp.so: $(DEPS_16)
	@echo '      [Link] libhttp'
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/httpLib.o $(LIBS_16) $(LIBS_16) $(LIBS)
...
$(CONFIG)/bin/http: $(DEPS_18)
	@echo '      [Link] http'
	$(CC) -o $(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/http.o $(LIBS_18) $(LIBS_18) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/libsqlite3.so: $(DEPS_21)
...
#
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_23 += $(CONFIG)/bin/libsqlite3.so
endif
...
$(CONFIG)/bin/sqlite: $(DEPS_23)
	@echo '      [Link] sqlite'
	$(CC) -o $(CONFIG)/bin/sqlite $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/sqlite.o $(LIBS_23) $(LIBS_23) $(LIBS) $(LDFLAGS)
endif
...
$(CONFIG)/bin/ejs: $(DEPS_98)
	@echo '      [Link] ejs'
	$(CC) -o $(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS_98) $(LIBS_98) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/ejsc: $(DEPS_100)
	@echo '      [Link] ejsc'
	$(CC) -o $(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBS_100) $(LIBS_100) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/ejsmod: $(DEPS_107)
	@echo '      [Link] ejsmod'
	$(CC) -o $(CONFIG)/bin/ejsmod $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsmod.o $(CONFIG)/obj/doc.o $(CONFIG)/obj/docFiles.o $(CONFIG)/obj/listing.o $(CONFIG)/obj/slotGen.o $(LIBS_107) $(LIBS_107) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/ejsrun: $(DEPS_109)
	@echo '      [Link] ejsrun'
	$(CC) -o $(CONFIG)/bin/ejsrun $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_109) $(LIBS_109) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/jem: $(DEPS_113)
	@echo '      [Link] jem'
	$(CC) -o $(CONFIG)/bin/jem $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_113) $(LIBS_113) $(LIBS) -lmpr $(LDFLAGS)
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_118 += $(CONFIG)/bin/libsqlite3.so
endif
...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_118)
	@echo '      [Link] libejs.db.sqlite'
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsSqlite.o $(LIBS_118) $(LIBS_118) $(LIBS) -lpcre
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_126)
	@echo '      [Link] libejs.web'
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsHttpServer.o $(CONFIG)/obj/ejsRequest.o $(CONFIG)/obj/ejsSession.o $(CONFIG)/obj/ejsWeb.o $(LIBS_126) $(LIBS_126) $(LIBS) -lmpr
...
DEPS_131 += $(CONFIG)/bin/libzlib.so
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_131)
	@echo '      [Link] libejs.zlib'
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsZlib.o $(LIBS_131) $(LIBS_131) $(LIBS) -lmpr
...
$(CONFIG)/bin/mvc: $(DEPS_134)
	@echo '      [Link] mvc'
	$(CC) -o $(CONFIG)/bin/mvc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_134) $(LIBS_134) $(LIBS) -lmpr $(LDFLAGS)
...
$(CONFIG)/bin/utest: $(DEPS_138)
	@echo '      [Link] utest'
	$(CC) -o $(CONFIG)/bin/utest $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsrun.o $(LIBS_138) $(LIBS_138) $(LIBS) -lmpr $(LDFLAGS)
