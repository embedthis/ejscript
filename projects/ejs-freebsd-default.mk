...
$(CONFIG)/bin/http: $(DEPS_108)
	...
	$(CC) -o $(CONFIG)/bin/http $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_108) $(LIBS_108) $(LIBS_108) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libejs.db.sqlite.so: $(DEPS_113)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.db.sqlite.so $(LIBPATHS) "$(CONFIG)/obj/ejsSqlite.o" $(LIBPATHS_113) $(LIBS_113) $(LIBS_113) $(LIBS) 
...
$(CONFIG)/bin/libejs.web.so: $(DEPS_119)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.web.so $(LIBPATHS) "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o" $(LIBPATHS_119) $(LIBS_119) $(LIBS_119) $(LIBS) 
...
$(CONFIG)/bin/libejs.zlib.so: $(DEPS_124)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.zlib.so $(LIBPATHS) "$(CONFIG)/obj/ejsZlib.o" $(LIBPATHS_124) $(LIBS_124) $(LIBS_124) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_129)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_129) $(LIBS_129) $(LIBS_129) $(LIBS) 
