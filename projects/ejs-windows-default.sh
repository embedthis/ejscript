#
#   ejs-windows-default.sh -- Build It Shell Script to build Embedthis Ejscript
#
...
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.unix.mod
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/jem.es
...
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.db.mod
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.db.mapper.mod
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.db.sqlite.mod
...
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.template.mod
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.zlib.mod
...
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.tar.mod
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/mvc.es
...
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/ejs.mvc.mod
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/utest.es
#  Omit build script /Users/mob/git/ejs/windows-x86-default/bin/utest.worker
