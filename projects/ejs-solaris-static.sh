#
#   ejs-solaris-static.sh -- Build It Shell Script to build Embedthis Ejscript
#
...
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.unix.mod
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/jem.es
...
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.db.mod
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.db.mapper.mod
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.db.sqlite.mod
...
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.template.mod
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.zlib.mod
...
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.tar.mod
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/mvc.es
...
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/ejs.mvc.mod
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/utest.es
#  Omit build script /Users/mob/git/ejs/solaris-x86-static/bin/utest.worker
