...
macosx-i686-debug/bin/utest.es: 
...
$(PLATFORM)/lib/ejs.web.dylib:  \
        ...
        $(PLATFORM)/obj/ejsRequest.o \
        $(PLATFORM)/obj/ejsSession.o
	$(CC) -dynamiclib -o $(PLATFORM)/lib/ejs.web.dylib -arch i686 $(LDFLAGS) -install_name @rpath/ejs.web.dylib $(PLATFORM)/obj/ejsHttpServer.o $(PLATFORM)/obj/ejsWeb.o $(PLATFORM)/obj/ejsRequest.o $(PLATFORM)/obj/ejsSession.o $(LIBS) -lmpr -lhttp -lpcre -lpcre -lejs
...
macosx-i686-debug/bin/utest.worker: 
