...
DEPS_114 += $(BUILD)/inc/config.h
DEPS_114 += $(BUILD)/inc/mbedtls.h
DEPS_114 += $(BUILD)/obj/mbedtls.o

$(BUILD)/bin/libmbedtls.a: $(DEPS_114)
...
#   libmpr-mbedtls
#
DEPS_115 += $(BUILD)/bin/libmbedtls.a
DEPS_115 += $(BUILD)/obj/mpr-mbedtls.o

$(BUILD)/bin/libmpr-mbedtls.a: $(DEPS_115)
...
#   libmpr-openssl
#
DEPS_116 += $(BUILD)/obj/mpr-openssl.o

$(BUILD)/bin/libmpr-openssl.a: $(DEPS_116)
...
#   libzlib
#
DEPS_117 += $(BUILD)/inc/zlib.h
DEPS_117 += $(BUILD)/obj/zlib.o

$(BUILD)/bin/libzlib.dylib: $(DEPS_117)
...
ifeq ($(ME_COM_MBEDTLS),1)
    DEPS_118 += $(BUILD)/bin/libmpr-mbedtls.a
endif
ifeq ($(ME_COM_MBEDTLS),1)
    DEPS_118 += $(BUILD)/bin/libmbedtls.a
endif
ifeq ($(ME_COM_OPENSSL),1)
    DEPS_118 += $(BUILD)/bin/libmpr-openssl.a
endif
ifeq ($(ME_COM_ZLIB),1)
    DEPS_118 += $(BUILD)/bin/libzlib.dylib
endif
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_118 += -lmpr-mbedtls
endif
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_118 += -lmbedtls
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_118 += -lmpr-openssl
endif
ifeq ($(ME_COM_OPENSSL),1)
ifeq ($(ME_COM_SSL),1)
    LIBS_118 += -lssl
    LIBPATHS_118 += -L"$(ME_COM_OPENSSL_PATH)"
    LIBPATHS_118 += -L"$(ME_COM_OPENSSL_PATH)/lib"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_118 += -lcrypto
...
$(BUILD)/bin/libmpr.dylib: $(DEPS_118)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libmpr.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_118) $(LIBS_118) $(LIBS_118) $(LIBS) 
...
ifeq ($(ME_COM_SSL),1)
    ...
    LIBPATHS_120 += -L"$(ME_COM_OPENSSL_PATH)/lib"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_120 += -lcrypto
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_120)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libhttp.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_120) $(LIBS_120) $(LIBS_120) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/ejsmod: $(DEPS_124)
	...
	$(CC) -o $(BUILD)/bin/ejsmod -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_124) $(LIBS_124) $(LIBS_124) $(LIBS) -lpam 
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_133 += $(BUILD)/bin/libzlib.dylib
endif
...
ifeq ($(ME_COM_SSL),1)
    ...
    LIBPATHS_133 += -L"$(ME_COM_OPENSSL_PATH)/lib"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_133 += -lcrypto
...
$(BUILD)/bin/libejs.zlib.dylib: $(DEPS_133)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.zlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsZlib.o" $(LIBPATHS_133) $(LIBS_133) $(LIBS_133) $(LIBS) -lpam 
...
DEPS_134 += $(BUILD)/bin/libejs.zlib.dylib
...
ifeq ($(ME_COM_SSL),1)
    ...
    LIBPATHS_136 += -L"$(ME_COM_OPENSSL_PATH)/lib"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_136 += -lcrypto
...
#   httpcmd
#
DEPS_137 += $(BUILD)/bin/libhttp.dylib
...
#   install-roots
#
DEPS_138 += src/certs/roots.crt

$(BUILD)/bin/roots.crt: $(DEPS_138)
...
ifeq ($(ME_COM_SSL),1)
    ...
    LIBPATHS_139 += -L"$(ME_COM_OPENSSL_PATH)/lib"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_139 += -lcrypto
...
$(BUILD)/bin/libejs.web.dylib: $(DEPS_139)
	@echo '      [Link] $(BUILD)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.web.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   -install_name @rpath/libejs.web.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_139) $(LIBS_139) $(LIBS_139) $(LIBS) -lpam 
...
$(BUILD)/bin/mvc: $(DEPS_141)
	...
	$(CC) -o $(BUILD)/bin/mvc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_141) $(LIBS_141) $(LIBS_141) $(LIBS) -lpam 
...
#   utest
#
DEPS_144 += $(BUILD)/bin/libejs.dylib
...
ifeq ($(ME_COM_SSL),1)
    ...
    LIBPATHS_144 += -L"$(ME_COM_OPENSSL_PATH)/lib"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_144 += -lcrypto
...
$(BUILD)/bin/utest: $(DEPS_144)
	...
	$(CC) -o $(BUILD)/bin/utest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) -lpam 
