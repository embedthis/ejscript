...
$(BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o $(BUILD)/obj/mbedtls.o -arch $(CC_ARCH) $(CFLAGS) -O1 $(DFLAGS) -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/mbedtls/mbedtls.c
...
$(BUILD)/bin/libzlib.dylib: $(DEPS_127)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_128 += $(BUILD)/bin/libzlib.dylib
endif
...
$(BUILD)/bin/libmpr.dylib: $(DEPS_128)
	@echo '      [Link] $(BUILD)/bin/libmpr.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmpr.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) 
...
$(BUILD)/bin/libpcre.dylib: $(DEPS_129)
...
#   libhttp
#
DEPS_130 += $(BUILD)/bin/libmpr.dylib
ifeq ($(ME_COM_PCRE),1)
    DEPS_130 += $(BUILD)/bin/libpcre.dylib
endif
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_130)
	@echo '      [Link] $(BUILD)/bin/libhttp.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libhttp.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_130) $(LIBS_130) $(LIBS_130) $(LIBS) -lpam 
endif
...
DEPS_131 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_131 += $(BUILD)/bin/libhttp.dylib
endif
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_144 += $(BUILD)/bin/libzlib.dylib
endif
...
$(BUILD)/bin/libejs.zlib.dylib: $(DEPS_144)
	@echo '      [Link] $(BUILD)/bin/libejs.zlib.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.zlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.zlib.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsZlib.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) -lpam 
...
DEPS_145 += $(BUILD)/bin/libejs.zlib.dylib
...
DEPS_146 += $(BUILD)/bin/libejs.zlib.dylib
...
#   httpcmd
#
DEPS_148 += $(BUILD)/bin/libhttp.dylib
...
$(BUILD)/bin/libsql.dylib: $(DEPS_151)
	@echo '      [Link] $(BUILD)/bin/libsql.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libsql.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libsql.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/sqlite3.o" $(LIBS) 
endif

#
#   libejs.db.sqlite
#
DEPS_152 += $(BUILD)/bin/libmpr.dylib
DEPS_152 += $(BUILD)/bin/libejs.dylib
DEPS_152 += $(BUILD)/bin/ejs.mod
DEPS_152 += $(BUILD)/bin/ejs.db.sqlite.mod
ifeq ($(ME_COM_SQLITE),1)
    DEPS_152 += $(BUILD)/bin/libsql.dylib
endif
...
$(BUILD)/bin/libejs.db.sqlite.dylib: $(DEPS_152)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.db.sqlite.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.db.sqlite.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_152) $(LIBS_152) $(LIBS_152) $(LIBS) -lpam 

#
#   libejs.web
#
DEPS_153 += $(BUILD)/bin/libejs.dylib
...
$(BUILD)/bin/libejs.web.dylib: $(DEPS_153)
	@echo '      [Link] $(BUILD)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.web.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.web.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_153) $(LIBS_153) $(LIBS_153) $(LIBS) -lpam 
...
#   mvc
#
DEPS_155 += $(BUILD)/bin/libejs.dylib
...
$(BUILD)/bin/mvc: $(DEPS_155)
	...
	$(CC) -o $(BUILD)/bin/mvc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_155) $(LIBS_155) $(LIBS_155) $(LIBS) -lpam 
...
#   utest
#
DEPS_158 += $(BUILD)/bin/libejs.dylib
...
$(BUILD)/bin/utest: $(DEPS_158)
	...
	$(CC) -o $(BUILD)/bin/utest -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_158) $(LIBS_158) $(LIBS_158) $(LIBS) -lpam 

#
#   watchdog
#
DEPS_159 += $(BUILD)/bin/libmpr.dylib
...
$(BUILD)/bin/ejsman: $(DEPS_159)
	...
	$(CC) -o $(BUILD)/bin/ejsman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_159) $(LIBS_159) $(LIBS_159) $(LIBS) 
