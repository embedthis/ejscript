...
$(BUILD)/bin/libmpr.dylib: $(DEPS_127)
	@echo '      [Link] $(BUILD)/bin/libmpr.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmpr.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_127) $(LIBS_127) $(LIBS_127) $(LIBS) 
...
$(BUILD)/bin/libpcre.dylib: $(DEPS_128)
...
#   libhttp
#
DEPS_129 += $(BUILD)/bin/libmpr.dylib
ifeq ($(ME_COM_PCRE),1)
    DEPS_129 += $(BUILD)/bin/libpcre.dylib
endif
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_129)
	@echo '      [Link] $(BUILD)/bin/libhttp.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_129) $(LIBS_129) $(LIBS_129) $(LIBS) -lpam 
endif
...
DEPS_130 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_130 += $(BUILD)/bin/libhttp.dylib
endif
...
$(BUILD)/bin/libzlib.dylib: $(DEPS_143)
