...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_142 += $(BUILD)/bin/libzlib.a
endif
DEPS_142 += $(BUILD)/obj/ejsZlib.o

$(BUILD)/bin/libejs.zlib.a: $(DEPS_142)
...
DEPS_144 += $(BUILD)/bin/libejs.zlib.a
...
$(BUILD)/bin/libejs.web.a: $(DEPS_150)
