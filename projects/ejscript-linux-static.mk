...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_118 += $(BUILD)/bin/libzlib.a
endif
DEPS_118 += $(BUILD)/inc/mpr.h
DEPS_118 += $(BUILD)/obj/mprLib.o

$(BUILD)/bin/libmpr.a: $(DEPS_118)
...
#   libhttp
#
DEPS_120 += $(BUILD)/bin/libmpr.a
ifeq ($(ME_COM_PCRE),1)
    DEPS_120 += $(BUILD)/bin/libpcre.a
endif
DEPS_120 += $(BUILD)/inc/http.h
DEPS_120 += $(BUILD)/obj/httpLib.o

$(BUILD)/bin/libhttp.a: $(DEPS_120)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_134 += $(BUILD)/bin/libzlib.a
endif
DEPS_134 += $(BUILD)/obj/ejsZlib.o

$(BUILD)/bin/libejs.zlib.a: $(DEPS_134)
...
DEPS_136 += $(BUILD)/bin/libejs.zlib.a
...
$(BUILD)/bin/libejs.web.a: $(DEPS_142)
