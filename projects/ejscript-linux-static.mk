...
$(BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o $(BUILD)/obj/mbedtls.o $(LDFLAGS) -Wno-format-zero-length $(DFLAGS) -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/mbedtls/mbedtls.c
...
#   libhttp
#
DEPS_126 += $(BUILD)/bin/libmpr.a
ifeq ($(ME_COM_PCRE),1)
    DEPS_126 += $(BUILD)/bin/libpcre.a
endif
DEPS_126 += $(BUILD)/inc/http.h
DEPS_126 += $(BUILD)/obj/httpLib.o

$(BUILD)/bin/libhttp.a: $(DEPS_126)
