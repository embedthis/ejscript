...
$(BUILD)/bin/ejs.db.sqlite.mod: $(DEPS_138)
	...
	"../../$(BUILD)/bin/ejsc" --out "../../$(BUILD)/bin/ejs.db.sqlite.mod" --debug --optimize 9 Sqlite.es ; \
...
$(BUILD)/bin/libsql.dylib: $(DEPS_150)
...
$(BUILD)/bin/libejs.db.sqlite.dylib: $(DEPS_151)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.db.sqlite.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.db.sqlite.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_151) $(LIBS_151) $(LIBS_151) $(LIBS) -lpam 
...
$(BUILD)/bin/libejs.web.dylib: $(DEPS_152)
	@echo '      [Link] $(BUILD)/bin/libejs.web.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.web.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.web.dylib -compatibility_version 2.7 -current_version 2.7 "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_152) $(LIBS_152) $(LIBS_152) $(LIBS) -lpam 
...
#   utest
#
DEPS_157 += $(BUILD)/bin/libejs.dylib
...
#   watchdog
#
DEPS_158 += $(BUILD)/bin/libmpr.dylib
