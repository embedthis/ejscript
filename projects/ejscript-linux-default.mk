...
#   httpLib.o
#
DEPS_101 += src/http/http.h
DEPS_101 += $(BUILD)/inc/pcre.h

$(BUILD)/obj/httpLib.o: \
    src/http/httpLib.c $(DEPS_101)
...
DEPS_102 += $(BUILD)/inc/ejsByteCodeTable.h

$(BUILD)/obj/listing.o: \
    src/cmd/listing.c $(DEPS_102)
...
$(BUILD)/obj/mpr-openssl.o: \
    src/mpr-openssl/mpr-openssl.c $(DEPS_103)
...
#   watchdog.o
#
DEPS_112 += $(BUILD)/inc/mpr.h

$(BUILD)/obj/watchdog.o: \
    src/watchdog/watchdog.c $(DEPS_112)
...
DEPS_136 += $(BUILD)/bin/libejs.zlib.so
...
$(BUILD)/bin/ejsrun: $(DEPS_137)
	...
	$(CC) -o $(BUILD)/bin/ejsrun $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_137) $(LIBS_137) $(LIBS_137) $(LIBS) $(LIBS) 

ifeq ($(ME_COM_HTTP),1)
#
#   httpcmd
#
DEPS_138 += $(BUILD)/bin/libhttp.so
...
$(BUILD)/bin/http: $(DEPS_138)
	...
	$(CC) -o $(BUILD)/bin/http $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/http.o" $(LIBPATHS_138) $(LIBS_138) $(LIBS_138) $(LIBS) $(LIBS) 
endif

#
#   install-certs
#
DEPS_139 += src/certs/samples/ca.crt
DEPS_139 += src/certs/samples/ca.key
DEPS_139 += src/certs/samples/ec.crt
DEPS_139 += src/certs/samples/ec.key
DEPS_139 += src/certs/samples/roots.crt
DEPS_139 += src/certs/samples/self.crt
DEPS_139 += src/certs/samples/self.key
DEPS_139 += src/certs/samples/test.crt
DEPS_139 += src/certs/samples/test.key

$(BUILD)/.install-certs-modified: $(DEPS_139)
	@echo '      [Copy] $(BUILD)/bin'
	mkdir -p "$(BUILD)/bin"
...
#   libsql
#
DEPS_140 += $(BUILD)/inc/sqlite3.h
DEPS_140 += $(BUILD)/obj/sqlite3.o

$(BUILD)/bin/libsql.so: $(DEPS_140)
...
DEPS_141 += $(BUILD)/bin/ejs.db.sqlite.mod
ifeq ($(ME_COM_SQLITE),1)
    DEPS_141 += $(BUILD)/bin/libsql.so
endif
DEPS_141 += $(BUILD)/obj/ejsSqlite.o
...
$(BUILD)/bin/libejs.db.sqlite.so: $(DEPS_141)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.so'
	$(CC) -shared -o $(BUILD)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_141) $(LIBS_141) $(LIBS_141) $(LIBS) 
...
DEPS_142 += $(BUILD)/inc/ejsWeb.h
DEPS_142 += $(BUILD)/obj/ejsHttpServer.o
DEPS_142 += $(BUILD)/obj/ejsRequest.o
DEPS_142 += $(BUILD)/obj/ejsSession.o
DEPS_142 += $(BUILD)/obj/ejsWeb.o
...
$(BUILD)/bin/libejs.web.so: $(DEPS_142)
	@echo '      [Link] $(BUILD)/bin/libejs.web.so'
	$(CC) -shared -o $(BUILD)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) 
...
$(BUILD)/bin/ejsman: $(DEPS_148)
	@echo '      [Link] $(BUILD)/bin/ejsman'
	$(CC) -o $(BUILD)/bin/ejsman $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_148) $(LIBS_148) $(LIBS_148) $(LIBS) $(LIBS) 

#
#   www
#
DEPS_149 += src/ejs.web/www/images/banner.jpg
DEPS_149 += src/ejs.web/www/images/favicon.ico
DEPS_149 += src/ejs.web/www/images/splash.jpg
DEPS_149 += src/ejs.web/www/js/jquery.ejs.min.js
DEPS_149 += src/ejs.web/www/js/jquery.min.js
DEPS_149 += src/ejs.web/www/js/jquery.simplemodal.min.js
DEPS_149 += src/ejs.web/www/js/jquery.tablesorter.js
DEPS_149 += src/ejs.web/www/js/jquery.tablesorter.min.js
DEPS_149 += src/ejs.web/www/js/jquery.treeview.min.js
DEPS_149 += src/ejs.web/www/js/tree-images/file.gif
DEPS_149 += src/ejs.web/www/js/tree-images/folder-closed.gif
DEPS_149 += src/ejs.web/www/js/tree-images/folder.gif
DEPS_149 += src/ejs.web/www/js/tree-images/minus.gif
DEPS_149 += src/ejs.web/www/js/tree-images/plus.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-black-line.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-black.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-default-line.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-default.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-famfamfam-line.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-famfamfam.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-gray-line.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-gray.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-red-line.gif
DEPS_149 += src/ejs.web/www/js/tree-images/treeview-red.gif
DEPS_149 += src/ejs.web/www/js/treeview.css
DEPS_149 += src/ejs.web/www/layout.css
DEPS_149 += src/ejs.web/www/themes/default.css

$(BUILD)/bin/www: $(DEPS_149)
...
#   install
#
DEPS_154 += installPrep
DEPS_154 += stop
DEPS_154 += installBinary
DEPS_154 += start
