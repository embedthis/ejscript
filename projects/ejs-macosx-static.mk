...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/ejs-macosx-static-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/ejs-macosx-static-me.h >/dev/null ; then\
		cp projects/ejs-macosx-static-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
...
ifeq ($(ME_COM_SQLITE),1)
    DEPS_112 += $(CONFIG)/bin/libsql.a
endif
DEPS_112 += $(CONFIG)/obj/ejsSqlite.o

$(CONFIG)/bin/libejs.db.sqlite.a: $(DEPS_112)
...
$(CONFIG)/bin/libejs.web.a: $(DEPS_118)
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_123 += $(CONFIG)/bin/libpcre.a
endif
DEPS_123 += $(CONFIG)/inc/http.h
DEPS_123 += $(CONFIG)/obj/httpLib.o
ifeq ($(ME_COM_HTTP),1)
    DEPS_123 += $(CONFIG)/bin/libhttp.a
endif
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_123 += $(CONFIG)/bin/libzlib.a
endif
DEPS_123 += $(CONFIG)/obj/ejsZlib.o

$(CONFIG)/bin/libejs.zlib.a: $(DEPS_123)
...
ifeq ($(ME_COM_EST),1)
    DEPS_128 += $(CONFIG)/bin/libest.a
endif
DEPS_128 += $(CONFIG)/obj/mprSsl.o

$(CONFIG)/bin/libmprssl.a: $(DEPS_128)
