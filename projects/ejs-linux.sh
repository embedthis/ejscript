...
${CC} -c -o ${CONFIG}\obj\adler32.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/adler32.c

${CC} -c -o ${CONFIG}\obj\compress.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/compress.c

${CC} -c -o ${CONFIG}\obj\crc32.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/crc32.c

${CC} -c -o ${CONFIG}\obj\deflate.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/deflate.c

${CC} -c -o ${CONFIG}\obj\gzclose.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/gzclose.c

${CC} -c -o ${CONFIG}\obj\gzlib.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/gzlib.c

${CC} -c -o ${CONFIG}\obj\gzread.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/gzread.c

${CC} -c -o ${CONFIG}\obj\gzwrite.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/gzwrite.c

${CC} -c -o ${CONFIG}\obj\infback.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/infback.c

${CC} -c -o ${CONFIG}\obj\inffast.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/inffast.c

${CC} -c -o ${CONFIG}\obj\inflate.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/inflate.c

${CC} -c -o ${CONFIG}\obj\inftrees.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/inftrees.c

${CC} -c -o ${CONFIG}\obj\trees.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/trees.c

${CC} -c -o ${CONFIG}\obj\uncompr.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/uncompr.c

${CC} -c -o ${CONFIG}\obj\zutil.o ${CFLAGS} ${DFLAGS} -I${CONFIG}\inc src/deps/zlib/zutil.c
...
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/utest.es
rm -rf ${CONFIG}/bin/utest
cp -r ${CONFIG}/bin/ejsrun ${CONFIG}/bin/utest

#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.unix.mod
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/jem.es
rm -rf ${CONFIG}/bin/jem
cp -r ${CONFIG}/bin/ejsrun ${CONFIG}/bin/jem

#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.db.mod
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.db.mapper.mod
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.db.sqlite.mod
...
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.template.mod
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.tar.mod
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.zlib.mod
${CC} -shared -o ${CONFIG}\bin\ejs.zlib.so ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\ejsZlib.o ${LIBS} -lmpr -lejs -lhttp -lpcre -lzlib

#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/mvc.es
rm -rf ${CONFIG}/bin/mvc
cp -r ${CONFIG}/bin/ejsrun ${CONFIG}/bin/mvc

#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/ejs.mvc.mod
#  Omit build script C:/cygwin/home/mob/ejs/linux-x86-debug/bin/utest.worker
