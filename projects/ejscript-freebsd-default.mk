...
ifeq ($(ME_COM_SSL),1)
    LIBS_151 += -lssl
    LIBPATHS_151 += -L"$(ME_COM_OPENSSL_PATH)"
endif
endif
ifeq ($(ME_COM_OPENSSL),1)
    LIBS_151 += -lcrypto
...
$(BUILD)/bin/libejs.db.sqlite.so: $(DEPS_151)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.so'
	$(CC) -shared -o $(BUILD)/bin/libejs.db.sqlite.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_151) $(LIBS_151) $(LIBS_151) $(LIBS) 
...
$(BUILD)/bin/libejs.web.so: $(DEPS_152)
	@echo '      [Link] $(BUILD)/bin/libejs.web.so'
	$(CC) -shared -o $(BUILD)/bin/libejs.web.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_152) $(LIBS_152) $(LIBS_152) $(LIBS) 
...
$(BUILD)/bin/mvc: $(DEPS_154)
	...
	$(CC) -o $(BUILD)/bin/mvc $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_154) $(LIBS_154) $(LIBS_154) $(LIBS) $(LIBS) 
...
$(BUILD)/bin/utest: $(DEPS_157)
	...
	$(CC) -o $(BUILD)/bin/utest $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_157) $(LIBS_157) $(LIBS_157) $(LIBS) $(LIBS) 

#
#   watchdog
#
DEPS_158 += $(BUILD)/bin/libmpr.so
...
$(BUILD)/bin/ejsman: $(DEPS_158)
	...
	$(CC) -o $(BUILD)/bin/ejsman $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_158) $(LIBS_158) $(LIBS_158) $(LIBS) $(LIBS) 
