...
$(BUILD)/bin/libmpr.so: $(DEPS_127)
	@echo '      [Link] $(BUILD)/bin/libmpr.so'
	$(CC) -shared -o $(BUILD)/bin/libmpr.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/mprLib.o" $(LIBPATHS_127) $(LIBS_127) $(LIBS_127) $(LIBS) 
...
#   libhttp
#
DEPS_129 += $(BUILD)/bin/libmpr.so
ifeq ($(ME_COM_PCRE),1)
    DEPS_129 += $(BUILD)/bin/libpcre.so
endif
...
$(BUILD)/bin/libhttp.so: $(DEPS_129)
	@echo '      [Link] $(BUILD)/bin/libhttp.so'
	$(CC) -shared -o $(BUILD)/bin/libhttp.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/httpLib.o" $(LIBPATHS_129) $(LIBS_129) $(LIBS_129) $(LIBS) 
endif
