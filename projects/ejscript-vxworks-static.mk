...
ME_CONFIGURE          ?= \"me -d -q -platform vxworks-x86-static -static -configure . -gen make\"
ME_CONFIGURED         ?= 1
ME_DEPTH              ?= 1
...
$(BUILD)/bin/mvc.out: $(DEPS_155)
	...
	$(CC) -o $(BUILD)/bin/mvc.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_155) $(LIBS_155) $(LIBS_155) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/utest.out: $(DEPS_158)
	...
	$(CC) -o $(BUILD)/bin/utest.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_158) $(LIBS_158) $(LIBS_158) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/ejsman.out: $(DEPS_159)
	...
	$(CC) -o $(BUILD)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_159) $(LIBS_159) $(LIBS_159) $(LIBS) -Wl,-r 
