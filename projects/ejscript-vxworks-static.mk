...
$(BUILD)/bin/ejs.out: $(DEPS_131)
	...
	$(CC) -o $(BUILD)/bin/ejs.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_131) $(LIBS_131) $(LIBS_131) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/ejsc.out: $(DEPS_132)
	...
	$(CC) -o $(BUILD)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_132) $(LIBS_132) $(LIBS_132) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/ejsmod.out: $(DEPS_133)
	...
	$(CC) -o $(BUILD)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_133) $(LIBS_133) $(LIBS_133) $(LIBS) -Wl,-r 
