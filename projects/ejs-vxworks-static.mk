...
$(BUILD)/bin/libzlib.out: $(DEPS_139)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_140 += $(BUILD)/bin/libzlib.out
endif
DEPS_140 += $(BUILD)/obj/ejsZlib.o

$(BUILD)/bin/libejs.zlib.out: $(DEPS_140)
...
$(BUILD)/bin/libmprssl.out: $(DEPS_141)
...
#   manager
#
DEPS_142 += $(BUILD)/bin/libmpr.out
DEPS_142 += $(BUILD)/obj/manager.o

LIBS_142 += -lmpr

$(BUILD)/bin/ejsman.out: $(DEPS_142)
	@echo '      [Link] $(BUILD)/bin/ejsman.out'
	$(CC) -o $(BUILD)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/mvc.out: $(DEPS_144)
	@echo '      [Link] $(BUILD)/bin/mvc.out'
	$(CC) -o $(BUILD)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/utest.out: $(DEPS_147)
	@echo '      [Link] $(BUILD)/bin/utest.out'
	$(CC) -o $(BUILD)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_147) $(LIBS_147) $(LIBS_147) $(LIBS) -Wl,-r 
