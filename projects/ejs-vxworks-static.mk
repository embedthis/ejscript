...
$(CONFIG)/bin/httpcmd.out: $(DEPS_20)
	@echo '      [Link] $(CONFIG)/bin/httpcmd.out'
	 -o $(CONFIG)/bin/httpcmd.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_20) $(LIBS_20) $(LIBS_20) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/ejsman.out: $(DEPS_22)
	@echo '      [Link] $(CONFIG)/bin/ejsman.out'
	 -o $(CONFIG)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/libsql.a: $(DEPS_25)
	@echo '      [Link] $(CONFIG)/bin/libsql.a'
	 -cr $(CONFIG)/bin/libsql.a "$(CONFIG)/obj/sqlite3.o"
endif
...
$(CONFIG)/bin/sqlite.out: $(DEPS_27)
	@echo '      [Link] $(CONFIG)/bin/sqlite.out'
	 -o $(CONFIG)/bin/sqlite.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_27) $(LIBS_27) $(LIBS_27) $(LIBS) -Wl,-r 
endif
...
$(CONFIG)/bin/ejs.out: $(DEPS_102)
	@echo '      [Link] $(CONFIG)/bin/ejs.out'
	 -o $(CONFIG)/bin/ejs.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_102) $(LIBS_102) $(LIBS_102) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/ejsc.out: $(DEPS_104)
	@echo '      [Link] $(CONFIG)/bin/ejsc.out'
	 -o $(CONFIG)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_104) $(LIBS_104) $(LIBS_104) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/ejsmod.out: $(DEPS_111)
	@echo '      [Link] $(CONFIG)/bin/ejsmod.out'
	 -o $(CONFIG)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsmod.o" "$(CONFIG)/obj/doc.o" "$(CONFIG)/obj/docFiles.o" "$(CONFIG)/obj/listing.o" "$(CONFIG)/obj/slotGen.o" $(LIBPATHS_111) $(LIBS_111) $(LIBS_111) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/ejsrun.out: $(DEPS_113)
	@echo '      [Link] $(CONFIG)/bin/ejsrun.out'
	 -o $(CONFIG)/bin/ejsrun.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_113) $(LIBS_113) $(LIBS_113) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/libejs.db.sqlite.a: $(DEPS_120)
	@echo '      [Link] $(CONFIG)/bin/libejs.db.sqlite.a'
	 -cr $(CONFIG)/bin/libejs.db.sqlite.a "$(CONFIG)/obj/ejsSqlite.o"
...
$(CONFIG)/bin/libejs.web.a: $(DEPS_128)
	@echo '      [Link] $(CONFIG)/bin/libejs.web.a'
	 -cr $(CONFIG)/bin/libejs.web.a "$(CONFIG)/obj/ejsHttpServer.o" "$(CONFIG)/obj/ejsRequest.o" "$(CONFIG)/obj/ejsSession.o" "$(CONFIG)/obj/ejsWeb.o"
...
$(CONFIG)/bin/libejs.zlib.a: $(DEPS_133)
	@echo '      [Link] $(CONFIG)/bin/libejs.zlib.a'
	 -cr $(CONFIG)/bin/libejs.zlib.a "$(CONFIG)/obj/ejsZlib.o"
...
$(CONFIG)/bin/mvc.out: $(DEPS_136)
	@echo '      [Link] $(CONFIG)/bin/mvc.out'
	 -o $(CONFIG)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_136) $(LIBS_136) $(LIBS_136) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/utest.out: $(DEPS_140)
	@echo '      [Link] $(CONFIG)/bin/utest.out'
	 -o $(CONFIG)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_140) $(LIBS_140) $(LIBS_140) $(LIBS) -Wl,-r 
