...
$(CONFIG)/bin/http.out: $(DEPS_113)
	@echo '      [Link] $(CONFIG)/bin/http.out'
	$(CC) -o $(CONFIG)/bin/http.out $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/http.o" $(LIBPATHS_113) $(LIBS_113) $(LIBS_113) $(LIBS) -Wl,-r 
endif
...
DEPS_129 += $(CONFIG)/bin/ejsmod.out
...
$(CONFIG)/bin/ejsman.out: $(DEPS_131)
	...
	$(CC) -o $(CONFIG)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_131) $(LIBS_131) $(LIBS_131) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/mvc.out: $(DEPS_133)
	...
	$(CC) -o $(CONFIG)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_133) $(LIBS_133) $(LIBS_133) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/sqlite.out: $(DEPS_135)
	...
	$(CC) -o $(CONFIG)/bin/sqlite.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_135) $(LIBS_135) $(LIBS_135) $(LIBS) -Wl,-r 
endif
...
$(CONFIG)/bin/utest.out: $(DEPS_138)
	...
	$(CC) -o $(CONFIG)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_138) $(LIBS_138) $(LIBS_138) $(LIBS) -Wl,-r 
