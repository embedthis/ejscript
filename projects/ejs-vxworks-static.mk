...
DFLAGS                += -DVXWORKS -DRW_MULTI_THREAD -D_GNU_TOOL -DCPU=PENTIUM $(patsubst %,-D%,$(filter ME_%,$(MAKEFLAGS))) -DME_COM_COMPILER=$(ME_COM_COMPILER) -DME_COM_HTTP=$(ME_COM_HTTP) -DME_COM_LIB=$(ME_COM_LIB) -DME_COM_LINK=$(ME_COM_LINK) -DME_COM_MPR=$(ME_COM_MPR) -DME_COM_OSDEP=$(ME_COM_OSDEP) -DME_COM_PCRE=$(ME_COM_PCRE) -DME_COM_SQLITE=$(ME_COM_SQLITE) -DME_COM_SSL=$(ME_COM_SSL) -DME_COM_VXWORKS=$(ME_COM_VXWORKS) -DME_COM_WINSDK=$(ME_COM_WINSDK) -DME_COM_ZLIB=$(ME_COM_ZLIB) 
...
#   httpcmd
#
DEPS_136 += $(BUILD)/bin/libhttp.a
DEPS_136 += $(BUILD)/obj/http.o
...
$(BUILD)/bin/http.out: $(DEPS_136)
	@echo '      [Link] $(BUILD)/bin/http.out'
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/http.o" $(LIBPATHS_136) $(LIBS_136) $(LIBS_136) $(LIBS) -Wl,-r 
endif
...
#   install-certs
#
DEPS_137 += src/certs/samples/ca.crt
DEPS_137 += src/certs/samples/ca.key
DEPS_137 += src/certs/samples/dh.pem
DEPS_137 += src/certs/samples/ec.crt
DEPS_137 += src/certs/samples/ec.key
DEPS_137 += src/certs/samples/roots.crt
DEPS_137 += src/certs/samples/self.crt
DEPS_137 += src/certs/samples/self.key
DEPS_137 += src/certs/samples/test.crt
DEPS_137 += src/certs/samples/test.key
...
$(BUILD)/bin/libejs.web.a: $(DEPS_140)
...
$(BUILD)/bin/mvc.out: $(DEPS_142)
	@echo '      [Link] $(BUILD)/bin/mvc.out'
	$(CC) -o $(BUILD)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_142) $(LIBS_142) $(LIBS_142) $(LIBS) -Wl,-r 

ifeq ($(ME_COM_SSL),1)
#
#   openssl
#
DEPS_143 += $(BUILD)/obj/openssl.o

$(BUILD)/bin/libmpr-openssl.a: $(DEPS_143)
