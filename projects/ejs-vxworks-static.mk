...
$(BUILD)/bin/libpcre.out: $(DEPS_119)
...
#   libhttp
#
DEPS_120 += $(BUILD)/bin/libmpr.out
ifeq ($(ME_COM_PCRE),1)
    DEPS_120 += $(BUILD)/bin/libpcre.out
endif
DEPS_120 += $(BUILD)/inc/http.h
DEPS_120 += $(BUILD)/obj/httpLib.o

$(BUILD)/bin/libhttp.out: $(DEPS_120)
...
DEPS_121 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_121 += $(BUILD)/bin/libhttp.out
endif
...
$(BUILD)/bin/ejs.out: $(DEPS_122)
	@echo '      [Link] $(BUILD)/bin/ejs.out'
	$(CC) -o $(BUILD)/bin/ejs.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_122) $(LIBS_122) $(LIBS_122) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/ejsc.out: $(DEPS_123)
	@echo '      [Link] $(BUILD)/bin/ejsc.out'
	$(CC) -o $(BUILD)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_123) $(LIBS_123) $(LIBS_123) $(LIBS) -Wl,-r 

#
#   ejsmod
#
DEPS_124 += $(BUILD)/bin/libejs.out
...
$(BUILD)/bin/ejsmod.out: $(DEPS_124)
	@echo '      [Link] $(BUILD)/bin/ejsmod.out'
	$(CC) -o $(BUILD)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_124) $(LIBS_124) $(LIBS_124) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/libejs.web.out: $(DEPS_140)
...
$(BUILD)/bin/libzlib.out: $(DEPS_141)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_142 += $(BUILD)/bin/libzlib.out
endif
DEPS_142 += $(BUILD)/obj/ejsZlib.o

$(BUILD)/bin/libejs.zlib.out: $(DEPS_142)
...
ifeq ($(ME_COM_EST),1)
    DEPS_144 += $(BUILD)/bin/libest.out
endif
DEPS_144 += $(BUILD)/obj/mprSsl.o

$(BUILD)/bin/libmprssl.out: $(DEPS_144)
...
$(BUILD)/bin/ejsman.out: $(DEPS_145)
	...
	$(CC) -o $(BUILD)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_145) $(LIBS_145) $(LIBS_145) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/mvc.out: $(DEPS_147)
	@echo '      [Link] $(BUILD)/bin/mvc.out'
	$(CC) -o $(BUILD)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_147) $(LIBS_147) $(LIBS_147) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/utest.out: $(DEPS_150)
	@echo '      [Link] $(BUILD)/bin/utest.out'
	$(CC) -o $(BUILD)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_150) $(LIBS_150) $(LIBS_150) $(LIBS) -Wl,-r 
