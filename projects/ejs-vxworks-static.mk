...
#   libhttp
#
DEPS_124 += $(BUILD)/bin/libmpr.a
ifeq ($(ME_COM_PCRE),1)
    DEPS_124 += $(BUILD)/bin/libpcre.a
endif
DEPS_124 += $(BUILD)/inc/http.h
DEPS_124 += $(BUILD)/obj/httpLib.o

$(BUILD)/bin/libhttp.a: $(DEPS_124)
...
#   libejs.zlib
#
DEPS_139 += $(BUILD)/bin/libejs.a
DEPS_139 += $(BUILD)/bin/ejs.mod
ifeq ($(ME_COM_ZLIB),1)
    DEPS_139 += $(BUILD)/bin/libzlib.a
endif
DEPS_139 += $(BUILD)/obj/ejsZlib.o

$(BUILD)/bin/libejs.zlib.a: $(DEPS_139)
...
DEPS_140 += $(BUILD)/bin/libejs.zlib.a
...
DEPS_141 += $(BUILD)/bin/libejs.zlib.a
...
$(BUILD)/bin/libejs.web.a: $(DEPS_147)
