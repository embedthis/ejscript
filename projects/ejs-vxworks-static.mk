...
build/$(CONFIG)/bin/ejs.out: $(DEPS_84)
	...
	$(CC) -o build/$(CONFIG)/bin/ejs.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejs.o" $(LIBPATHS_84) $(LIBS_84) $(LIBS_84) $(LIBS) -Wl,-r 
...
build/$(CONFIG)/bin/ejsc.out: $(DEPS_86)
	...
	$(CC) -o build/$(CONFIG)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejsc.o" $(LIBPATHS_86) $(LIBS_86) $(LIBS_86) $(LIBS) -Wl,-r 
...
build/$(CONFIG)/bin/ejsmod.out: $(DEPS_93)
	...
	$(CC) -o build/$(CONFIG)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/doc.o" "build/$(CONFIG)/obj/docFiles.o" "build/$(CONFIG)/obj/ejsmod.o" "build/$(CONFIG)/obj/listing.o" "build/$(CONFIG)/obj/slotGen.o" $(LIBPATHS_93) $(LIBS_93) $(LIBS_93) $(LIBS) -Wl,-r 
...
build/$(CONFIG)/bin/ejsrun.out: $(DEPS_106)
	...
	$(CC) -o build/$(CONFIG)/bin/ejsrun.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_106) $(LIBS_106) $(LIBS_106) $(LIBS) -Wl,-r 
...
build/$(CONFIG)/bin/ejsman.out: $(DEPS_130)
	...
	$(CC) -o build/$(CONFIG)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/manager.o" $(LIBPATHS_130) $(LIBS_130) $(LIBS_130) $(LIBS) -Wl,-r 
...
build/$(CONFIG)/bin/mvc.out: $(DEPS_132)
	...
	$(CC) -o build/$(CONFIG)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_132) $(LIBS_132) $(LIBS_132) $(LIBS) -Wl,-r 
...
build/$(CONFIG)/bin/sqlite.out: $(DEPS_134)
	...
	$(CC) -o build/$(CONFIG)/bin/sqlite.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/sqlite.o" $(LIBPATHS_134) $(LIBS_134) $(LIBS_134) $(LIBS) -Wl,-r 
endif
...
build/$(CONFIG)/bin/utest.out: $(DEPS_137)
	...
	$(CC) -o build/$(CONFIG)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_137) $(LIBS_137) $(LIBS_137) $(LIBS) -Wl,-r 
