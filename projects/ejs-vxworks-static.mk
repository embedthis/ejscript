...
$(CONFIG)/bin/ejsrun.out: $(DEPS_106)
	...
	$(CC) -o $(CONFIG)/bin/ejsrun.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_106) $(LIBS_106) $(LIBS_106) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/ejsman.out: $(DEPS_130)
	...
	$(CC) -o $(CONFIG)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_130) $(LIBS_130) $(LIBS_130) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/mvc.out: $(DEPS_132)
	...
	$(CC) -o $(CONFIG)/bin/mvc.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_132) $(LIBS_132) $(LIBS_132) $(LIBS) -Wl,-r 
...
$(CONFIG)/bin/sqlite.out: $(DEPS_134)
	...
	$(CC) -o $(CONFIG)/bin/sqlite.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_134) $(LIBS_134) $(LIBS_134) $(LIBS) -Wl,-r 
endif
...
$(CONFIG)/bin/utest.out: $(DEPS_137)
	...
	$(CC) -o $(CONFIG)/bin/utest.out $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsrun.o" $(LIBPATHS_137) $(LIBS_137) $(LIBS_137) $(LIBS) -Wl,-r 
