...
$(BUILD)/bin/ejs.out: $(DEPS_111)
	...
	$(CC) -o $(BUILD)/bin/ejs.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_111) $(LIBS_111) $(LIBS_111) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/ejsman.out: $(DEPS_131)
	...
	$(CC) -o $(BUILD)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_131) $(LIBS_131) $(LIBS_131) $(LIBS) -Wl,-r 
