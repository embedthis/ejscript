...
$(CONFIG)/bin/libhttp.dylib:  \
        ...
        $(CONFIG)/inc/http.h \
        $(CONFIG)/obj/httpLib.o
	$(CC) -dynamiclib -o $(CONFIG)\bin\libhttp.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.1 -current_version 2.0.1 -compatibility_version 2.0.1 -current_version 2.0.1 $(LIBPATHS) -install_name @rpath/libhttp.dylib $(CONFIG)\obj\httpLib.o $(LIBS) -lmpr -lpcre
...
$(CONFIG)/bin/ejs:  \
        $(CONFIG)/bin/libejs.dylib \
        $(CONFIG)/obj/ejs.o
	$(CC) -o $(CONFIG)\bin\ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)\obj\ejs.o $(LIBS) -lejs -lhttp -lmpr -lpcre -ledit -ledit
...
$(CONFIG)/bin/ejs.db.sqlite.dylib:  \
        ...
        $(CONFIG)/bin/libsqlite3.dylib \
        $(CONFIG)/obj/ejsSqlite.o
	$(CC) -dynamiclib -o $(CONFIG)\bin\ejs.db.sqlite.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.1 -current_version 2.0.1 -compatibility_version 2.0.1 -current_version 2.0.1 $(LIBPATHS) -install_name @rpath/ejs.db.sqlite.dylib $(CONFIG)\obj\ejsSqlite.o $(LIBS) -lmpr -lejs -lhttp -lpcre -lsqlite3
...
$(CONFIG)/bin/ejs.web.dylib:  \
        ...
        $(CONFIG)/obj/ejsSession.o \
        $(CONFIG)/obj/ejsWeb.o
	$(CC) -dynamiclib -o $(CONFIG)\bin\ejs.web.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.1 -current_version 2.0.1 -compatibility_version 2.0.1 -current_version 2.0.1 $(LIBPATHS) -install_name @rpath/ejs.web.dylib $(CONFIG)\obj\ejsHttpServer.o $(CONFIG)\obj\ejsRequest.o $(CONFIG)\obj\ejsSession.o $(CONFIG)\obj\ejsWeb.o $(LIBS) -lejs -lhttp -lmpr -lpcre
...
$(CONFIG)/bin/ejs.zlib.dylib:  \
        ...
        $(CONFIG)/bin/libzlib.dylib \
        $(CONFIG)/obj/ejsZlib.o
	$(CC) -dynamiclib -o $(CONFIG)\bin\ejs.zlib.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.1 -current_version 2.0.1 -compatibility_version 2.0.1 -current_version 2.0.1 $(LIBPATHS) -install_name @rpath/ejs.zlib.dylib $(CONFIG)\obj\ejsZlib.o $(LIBS) -lmpr -lejs -lhttp -lpcre -lzlib
