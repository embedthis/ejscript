...
$(CONFIG)/obj/ejsmod.o: \
        ...
        $(CONFIG)/inc/bit.h \
        src/cmd/ejsmod.h
	$(CC) -c -o $(CONFIG)/obj/ejsmod.o -Wall -fPIC $(LDFLAGS) -Wno-unused-result -Wshorten-64-to-32 -mtune=generic $(DFLAGS) -I$(CONFIG)/inc -Isrc/cmd src/cmd/ejsmod.c

$(CONFIG)/obj/doc.o: \
        src/cmd/doc.c \
        $(CONFIG)/inc/bit.h \
        src/cmd/ejsmod.h
	$(CC) -c -o $(CONFIG)/obj/doc.o -Wall -fPIC $(LDFLAGS) -Wno-unused-result -Wshorten-64-to-32 -mtune=generic $(DFLAGS) -I$(CONFIG)/inc -Isrc/cmd src/cmd/doc.c

$(CONFIG)/obj/docFiles.o: \
        src/cmd/docFiles.c \
        $(CONFIG)/inc/bit.h \
        src/cmd/ejsmod.h
	$(CC) -c -o $(CONFIG)/obj/docFiles.o -Wall -fPIC $(LDFLAGS) -Wno-unused-result -Wshorten-64-to-32 -mtune=generic $(DFLAGS) -I$(CONFIG)/inc -Isrc/cmd src/cmd/docFiles.c
...
$(CONFIG)/obj/slotGen.o: \
        ...
        $(CONFIG)/inc/bit.h \
        src/cmd/ejsmod.h
	$(CC) -c -o $(CONFIG)/obj/slotGen.o -Wall -fPIC $(LDFLAGS) -Wno-unused-result -Wshorten-64-to-32 -mtune=generic $(DFLAGS) -I$(CONFIG)/inc -Isrc/cmd src/cmd/slotGen.c
