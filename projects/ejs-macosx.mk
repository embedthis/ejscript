...
$(CONFIG)/bin/libmpr.dylib:  \
        $(CONFIG)/inc/mpr.h \
        $(CONFIG)/obj/mprLib.o
	$(DFLAGS)$(CC) -dynamiclib -o $(CONFIG)/bin/libmpr.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.0 -current_version 2.0.0 -compatibility_version 2.0.0 -current_version 2.0.0 $(LIBPATHS) -install_name @rpath/libmpr.dylib $(CONFIG)/obj/mprLib.o $(LIBS)
...
$(CONFIG)/bin/libmprssl.dylib:  \
        $(CONFIG)/bin/libmpr.dylib \
        $(CONFIG)/obj/mprSsl.o
	$(DFLAGS)$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.0 -current_version 2.0.0 -compatibility_version 2.0.0 -current_version 2.0.0 $(LIBPATHS) -install_name @rpath/libmprssl.dylib $(CONFIG)/obj/mprSsl.o $(LIBS) -lmpr
...
$(CONFIG)/bin/libhttp.dylib:  \
        ...
        $(CONFIG)/inc/http.h \
        $(CONFIG)/obj/httpLib.o
	$(DFLAGS)$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.0 -current_version 2.0.0 -compatibility_version 2.0.0 -current_version 2.0.0 $(LIBPATHS) -install_name @rpath/libhttp.dylib $(CONFIG)/obj/httpLib.o $(LIBS) -lpam -lmpr -lpcre -lmprssl
...
$(CONFIG)/bin/libsqlite3.dylib:  \
        $(CONFIG)/inc/sqlite3.h \
        $(CONFIG)/obj/sqlite3.o
	$(DFLAGS)$(CC) -dynamiclib -o $(CONFIG)/bin/libsqlite3.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.0 -current_version 2.0.0 -compatibility_version 2.0.0 -current_version 2.0.0 $(LIBPATHS) -install_name @rpath/libsqlite3.dylib $(CONFIG)/obj/sqlite3.o $(LIBS)
...
$(CONFIG)/bin/ejs:  \
        $(CONFIG)/bin/libejs.dylib \
        $(CONFIG)/obj/ejs.o
	$(DFLAGS)$(CC) -o $(CONFIG)/bin/ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS) -lejs -lhttp -lpam -lmpr -lpcre -lmprssl -ledit -ledit
...
$(CONFIG)/bin/ejs.db.sqlite.dylib:  \
        ...
        $(CONFIG)/bin/libsqlite3.dylib \
        $(CONFIG)/obj/ejsSqlite.o
	$(DFLAGS)$(CC) -dynamiclib -o $(CONFIG)/bin/ejs.db.sqlite.dylib -arch x86_64 $(LDFLAGS) -compatibility_version 2.0.0 -current_version 2.0.0 -compatibility_version 2.0.0 -current_version 2.0.0 $(LIBPATHS) -install_name @rpath/ejs.db.sqlite.dylib $(CONFIG)/obj/ejsSqlite.o $(LIBS) -lmpr -lejs -lhttp -lpam -lpcre -lmprssl -lsqlite3
