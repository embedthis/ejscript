...
$(BUILD)/bin/libpcre.out: $(DEPS_128)
...
#   libhttp
#
DEPS_129 += $(BUILD)/bin/libmpr.out
ifeq ($(ME_COM_PCRE),1)
    DEPS_129 += $(BUILD)/bin/libpcre.out
endif
DEPS_129 += $(BUILD)/inc/http.h
DEPS_129 += $(BUILD)/obj/httpLib.o

$(BUILD)/bin/libhttp.out: $(DEPS_129)
...
DEPS_130 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_130 += $(BUILD)/bin/libhttp.out
endif
...
#   ejs
#
DEPS_131 += $(BUILD)/bin/libejs.out
DEPS_131 += $(BUILD)/obj/ejs.o

$(BUILD)/bin/ejs.out: $(DEPS_131)
...
$(BUILD)/bin/libzlib.out: $(DEPS_143)
