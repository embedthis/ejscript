...
$(BUILD)/obj/zlib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/zlib.o $(CFLAGS) -Wno-deprecated-non-prototype -DME_DEBUG=1 -DVXWORKS -DRW_MULTI_THREAD -DCPU=PENTIUM -DTOOL_FAMILY=gnu -DTOOL=gnu -D_GNU_TOOL -D_WRS_KERNEL_ -D_VSB_CONFIG_FILE=\"/WindRiver/vxworks-7/samples/prebuilt_projects/vsb_vxsim_linux/h/config/vsbConfig.h\" $(IFLAGS) src/zlib/zlib.c
...
$(BUILD)/bin/libmpr.out: $(DEPS_128)
	@echo '      [Link] $(BUILD)/bin/libmpr.out'
	$(CC) -r -o $(BUILD)/bin/libmpr.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprLib.o" -lmpr-openssl $(LIBPATHS_128) $(LIBS_128) $(LIBS_128) $(LIBS) -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/libpcre.out: $(DEPS_129)
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_130 += $(BUILD)/bin/libpcre.out
endif
...
$(BUILD)/bin/libhttp.out: $(DEPS_130)
	@echo '      [Link] $(BUILD)/bin/libhttp.out'
	$(CC) -r -o $(BUILD)/bin/libhttp.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/httpLib.o" $(LIBPATHS_130) $(LIBS_130) $(LIBS_130) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 
endif
...
DEPS_131 += slots
ifeq ($(ME_COM_HTTP),1)
    DEPS_131 += $(BUILD)/bin/libhttp.out
endif
...
$(BUILD)/bin/ejs.out: $(DEPS_132)
	...
	$(CC) -o $(BUILD)/bin/ejs.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejs.o" $(LIBPATHS_132) $(LIBS_132) $(LIBS_132) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/ejsc.out: $(DEPS_133)
	...
	$(CC) -o $(BUILD)/bin/ejsc.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsc.o" $(LIBPATHS_133) $(LIBS_133) $(LIBS_133) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/ejsmod.out: $(DEPS_134)
	...
	$(CC) -o $(BUILD)/bin/ejsmod.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/doc.o" "$(BUILD)/obj/docFiles.o" "$(BUILD)/obj/ejsmod.o" "$(BUILD)/obj/listing.o" "$(BUILD)/obj/slotGen.o" $(LIBPATHS_134) $(LIBS_134) $(LIBS_134) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_144 += $(BUILD)/bin/libzlib.out
endif
...
$(BUILD)/bin/libejs.zlib.out: $(DEPS_144)
	@echo '      [Link] $(BUILD)/bin/libejs.zlib.out'
	$(CC) -r -o $(BUILD)/bin/libejs.zlib.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsZlib.o" $(LIBPATHS_144) $(LIBS_144) $(LIBS_144) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 
...
DEPS_145 += $(BUILD)/bin/libejs.zlib.out
...
DEPS_146 += $(BUILD)/bin/libejs.zlib.out
...
$(BUILD)/bin/ejsrun.out: $(DEPS_147)
	...
	$(CC) -o $(BUILD)/bin/ejsrun.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_147) $(LIBS_147) $(LIBS_147) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 

ifeq ($(ME_COM_HTTP),1)
#
#   httpcmd
#
DEPS_148 += $(BUILD)/bin/libhttp.out
...
$(BUILD)/bin/libejs.db.sqlite.out: $(DEPS_152)
	@echo '      [Link] $(BUILD)/bin/libejs.db.sqlite.out'
	$(CC) -r -o $(BUILD)/bin/libejs.db.sqlite.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsSqlite.o" $(LIBPATHS_152) $(LIBS_152) $(LIBS_152) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 

#
#   libejs.web
#
DEPS_153 += $(BUILD)/bin/libejs.out
...
$(BUILD)/bin/libejs.web.out: $(DEPS_153)
	@echo '      [Link] $(BUILD)/bin/libejs.web.out'
	$(CC) -r -o $(BUILD)/bin/libejs.web.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsHttpServer.o" "$(BUILD)/obj/ejsRequest.o" "$(BUILD)/obj/ejsSession.o" "$(BUILD)/obj/ejsWeb.o" $(LIBPATHS_153) $(LIBS_153) $(LIBS_153) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/mvc.out: $(DEPS_155)
	@echo '      [Link] $(BUILD)/bin/mvc.out'
	$(CC) -o $(BUILD)/bin/mvc.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_155) $(LIBS_155) $(LIBS_155) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/utest.out: $(DEPS_158)
	@echo '      [Link] $(BUILD)/bin/utest.out'
	$(CC) -o $(BUILD)/bin/utest.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsrun.o" $(LIBPATHS_158) $(LIBS_158) $(LIBS_158) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 

#
#   watchdog
#
DEPS_159 += $(BUILD)/bin/libmpr.out
...
$(BUILD)/bin/ejsman.out: $(DEPS_159)
	@echo '      [Link] $(BUILD)/bin/ejsman.out'
	$(CC) -o $(BUILD)/bin/ejsman.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_159) $(LIBS_159) $(LIBS_159) $(LIBS) -lmpr-openssl -lmpr-mbedtls -lmbedtls -Wl,-r 
