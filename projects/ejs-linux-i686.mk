...
$(CONFIG)/obj/sqlite3.o: \
        ...
        $(CONFIG)/inc/bit.h
	$(CC) -c -o $(CONFIG)/obj/sqlite3.o -fPIC -g -Wno-unused-result -mtune=i686 -w -w -I$(CONFIG)/inc src/deps/sqlite/sqlite3.c
...
$(CONFIG)/bin/utest:  \
	...
	cp -r linux-i686-debug/bin/ejsrun $(CONFIG)/bin/utest
...
$(CONFIG)/bin/jem:  \
	...
	cp -r linux-i686-debug/bin/ejsrun $(CONFIG)/bin/jem
...
$(CONFIG)/bin/mvc:  \
	...
	cp -r linux-i686-debug/bin/ejsrun $(CONFIG)/bin/mvc
